    ...
    $("#table_list").bootstrapTable({
        ...
        onDblClickRow: function (row) {
            layer.open({
              ...
              shade: false,
              area: ['420px', '280px'],
              content: '/infoPayController/info/' + row.id,
              end: function(index){
              }
            });
        },
...
function edit(id){
    layer.open({
        ...
        shade: false,
        area: ['420px', '280px'],
        content: '/infoPayController/edit/' + id,
        end: function(index){
