...
public class ShiroKit {
     ...
     * @return ShiroUser
     */
    public static ShiroUserModel getUser() {
        if (isGuest()) {
            return null;
        } else {
            return (ShiroUserModel) getSubject().getPrincipals().getPrimaryPrincipal();
        }
    }
     ...
     * 获取当前用户的部门数据范围的集合
     */
    public static List<Integer> getDeptDataScope(SystemUserEntity user) {
