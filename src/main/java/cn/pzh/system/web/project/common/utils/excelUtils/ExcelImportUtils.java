package cn.pzh.system.web.project.common.utils.excelUtils;

import cn.pzh.system.web.project.common.utils.CloseIOUtil;
import java.io.File;
...
public class ExcelImportUtils{
     ...
     * 功能:真正实现导入
     */
    private static List<Object> doImportExcel(String originUrl,int startRow,int endRow,boolean showInfo,Class<?> clazz)
            throws IOException {
        // 判断文件是否存在
        ...
        try {
			...
			wb = getWorkbook(fis,file.getName());
			if(null == wb){
     ...
     * @throws Exception  
     */    
    public static  Workbook getWorkbook(FileInputStream inStr,String fileName) throws IOException{
        Workbook wb = null;    
