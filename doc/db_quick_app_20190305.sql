-- --------------------------------------------------------
-- ホスト:                          localhost
-- サーバのバージョン:                    5.5.54 - MySQL Community Server (GPL)
-- サーバー OS:                      Win64
...
-- Dumping database structure for db_quick_app
DROP DATABASE IF EXISTS `db_quick_app`;
CREATE DATABASE IF NOT EXISTS `db_quick_app` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `db_quick_app`;


-- Dumping structure for テーブル db_quick_app.comm_file
DROP TABLE IF EXISTS `comm_file`;
CREATE TABLE IF NOT EXISTS `comm_file` (
...
-- Dumping data for table db_quick_app.comm_file: ~7 rows (approximately)
DELETE FROM `comm_file`;
/*!40000 ALTER TABLE `comm_file` DISABLE KEYS */;
INSERT INTO `comm_file` (`id`, `file_name`, `file_suffix`, `path`, `update_date`, `update_user`) VALUES
	(1, 'QQ截图20190116145307.png', '', '\\file\\080d6bd9-5f54-424f-b5b7-2f878fc7b678file', '2019-03-04', 'admin'),
	(2, 'QQ截图20190116145307.png', 'png', '\\file\\5438afc2-4ca8-442f-9166-6da235077d57.png', '2019-03-04', 'admin'),
	(3, 'QQ图片20190130180541.png', 'png', '\\file\\ab8761f4-a2c1-4baa-8dbb-8c919ebdf194.png', '2019-03-04', 'admin'),
	(4, '20170403151123232.png', 'png', '\\file\\92de2236-6b4d-467a-bdb6-22bb8549d1ca.png', '2019-03-04', 'admin'),
	(5, '20170403151123232.png', 'png', '\\file\\3c8ef99e-684c-4cd9-ba9c-8c18a09b6d3b.png', '2019-03-04', 'admin'),
	(6, 'QQ截图20190116145307.png', 'png', '\\fileavatar\\7900de4b-69ed-4742-945b-f774354c1607.png', '2019-03-04', 'admin'),
	(7, '20170403151123232.png', 'png', '\\file\\avatar\\5960af6b-a55d-4554-b4bb-3a814215219f.png', '2019-03-04', 'admin');
/*!40000 ALTER TABLE `comm_file` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.fix_area
DROP TABLE IF EXISTS `fix_area`;
CREATE TABLE IF NOT EXISTS `fix_area` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table db_quick_app.fix_area: 3,144 rows
DELETE FROM `fix_area`;
/*!40000 ALTER TABLE `fix_area` DISABLE KEYS */;
INSERT INTO `fix_area` (`id`, `area_id`, `area`, `father`) VALUES
	(1, '110101', '东城区', '110100'),
	(2, '110102', '西城区', '110100'),
	(3, '110103', '崇文区', '110100'),
	(4, '110104', '宣武区', '110100'),
...
/*!40000 ALTER TABLE `fix_area` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.fix_city
DROP TABLE IF EXISTS `fix_city`;
CREATE TABLE IF NOT EXISTS `fix_city` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table db_quick_app.fix_city: 345 rows
DELETE FROM `fix_city`;
/*!40000 ALTER TABLE `fix_city` DISABLE KEYS */;
INSERT INTO `fix_city` (`id`, `city_id`, `city`, `father`) VALUES
	(1, '110100', '市辖区', '110000'),
	(2, '110200', '县', '110000'),
	(3, '120100', '市辖区', '120000'),
	(4, '120200', '县', '120000'),
...
/*!40000 ALTER TABLE `fix_city` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.fix_county
...
CREATE TABLE IF NOT EXISTS `fix_county` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='省级固定存储表';

-- Dumping data for table db_quick_app.fix_county: 13 rows
DELETE FROM `fix_county`;
/*!40000 ALTER TABLE `fix_county` DISABLE KEYS */;
INSERT INTO `fix_county` (`id`, `county_id`, `county_name`, `father_province`) VALUES
	(1, '110100000000', '市辖区', '11'),
	(2, '120100000000', '市辖区', '12'),
	(3, '130100000000', '石家庄市', '13'),
	(4, '130200000000', '唐山市', '13'),
	(5, '130300000000', '秦皇岛市', '13'),
	(6, '130400000000', '邯郸市', '13'),
	(7, '130500000000', '邢台市', '13'),
	(8, '130600000000', '保定市', '13'),
	(9, '130700000000', '张家口市', '13'),
	(10, '130800000000', '承德市', '13'),
	(11, '130900000000', '沧州市', '13'),
	(12, '131000000000', '廊坊市', '13'),
	(13, '131100000000', '衡水市', '13');
/*!40000 ALTER TABLE `fix_county` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.fix_district
...
-- Dumping data for table db_quick_app.fix_district: 259 rows
DELETE FROM `fix_district`;
/*!40000 ALTER TABLE `fix_district` DISABLE KEYS */;
INSERT INTO `fix_district` (`id`, `district_id`, `district_name`, `father_county`) VALUES
	(1, '110101000000', '东城区', '110100000000'),
	(2, '110102000000', '西城区', '110100000000'),
	(3, '110105000000', '朝阳区', '110100000000'),
	(4, '110106000000', '丰台区', '110100000000'),
	(5, '110107000000', '石景山区', '110100000000'),
	(6, '110108000000', '海淀区', '110100000000'),
	(7, '110109000000', '门头沟区', '110100000000'),
	(8, '110111000000', '房山区', '110100000000'),
	(9, '110112000000', '通州区', '110100000000'),
	(10, '110113000000', '顺义区', '110100000000'),
	(11, '110114000000', '昌平区', '110100000000'),
	(12, '110115000000', '大兴区', '110100000000'),
	(13, '110116000000', '怀柔区', '110100000000'),
	(14, '110117000000', '平谷区', '110100000000'),
	(15, '110118000000', '密云区', '110100000000'),
	(16, '110119000000', '延庆区', '110100000000'),
	(17, '120101000000', '和平区', '120100000000'),
	(18, '120102000000', '河东区', '120100000000'),
	(19, '120103000000', '河西区', '120100000000'),
	(20, '120104000000', '南开区', '120100000000'),
	(21, '120105000000', '河北区', '120100000000'),
	(22, '120106000000', '红桥区', '120100000000'),
	(23, '120110000000', '东丽区', '120100000000'),
	(24, '120111000000', '西青区', '120100000000'),
	(25, '120112000000', '津南区', '120100000000'),
	(26, '120113000000', '北辰区', '120100000000'),
	(27, '120114000000', '武清区', '120100000000'),
	(28, '120115000000', '宝坻区', '120100000000'),
	(29, '120116000000', '滨海新区', '120100000000'),
	(30, '120117000000', '宁河区', '120100000000'),
	(31, '120118000000', '静海区', '120100000000'),
	(32, '120119000000', '蓟州区', '120100000000'),
	(33, '130101000000', '市辖区', '130100000000'),
	(34, '130102000000', '长安区', '130100000000'),
	(35, '130104000000', '桥西区', '130100000000'),
	(36, '130105000000', '新华区', '130100000000'),
	(37, '130107000000', '井陉矿区', '130100000000'),
	(38, '130108000000', '裕华区', '130100000000'),
	(39, '130109000000', '藁城区', '130100000000'),
	(40, '130110000000', '鹿泉区', '130100000000'),
	(41, '130111000000', '栾城区', '130100000000'),
	(42, '130121000000', '井陉县', '130100000000'),
	(43, '130123000000', '正定县', '130100000000'),
	(44, '130125000000', '行唐县', '130100000000'),
	(45, '130126000000', '灵寿县', '130100000000'),
	(46, '130127000000', '高邑县', '130100000000'),
	(47, '130128000000', '深泽县', '130100000000'),
	(48, '130129000000', '赞皇县', '130100000000'),
	(49, '130130000000', '无极县', '130100000000'),
	(50, '130131000000', '平山县', '130100000000'),
	(51, '130132000000', '元氏县', '130100000000'),
	(52, '130133000000', '赵县', '130100000000'),
	(53, '130171000000', '石家庄高新技术产业开发区', '130100000000'),
	(54, '130172000000', '石家庄循环化工园区', '130100000000'),
	(55, '130181000000', '辛集市', '130100000000'),
	(56, '130183000000', '晋州市', '130100000000'),
	(57, '130184000000', '新乐市', '130100000000'),
	(58, '130201000000', '市辖区', '130200000000'),
	(59, '130202000000', '路南区', '130200000000'),
	(60, '130203000000', '路北区', '130200000000'),
	(61, '130204000000', '古冶区', '130200000000'),
	(62, '130205000000', '开平区', '130200000000'),
	(63, '130207000000', '丰南区', '130200000000'),
	(64, '130208000000', '丰润区', '130200000000'),
	(65, '130209000000', '曹妃甸区', '130200000000'),
	(66, '130223000000', '滦县', '130200000000'),
	(67, '130224000000', '滦南县', '130200000000'),
	(68, '130225000000', '乐亭县', '130200000000'),
	(69, '130227000000', '迁西县', '130200000000'),
	(70, '130229000000', '玉田县', '130200000000'),
	(71, '130271000000', '唐山市芦台经济技术开发区', '130200000000'),
	(72, '130272000000', '唐山市汉沽管理区', '130200000000'),
	(73, '130273000000', '唐山高新技术产业开发区', '130200000000'),
	(74, '130274000000', '河北唐山海港经济开发区', '130200000000'),
	(75, '130281000000', '遵化市', '130200000000'),
	(76, '130283000000', '迁安市', '130200000000'),
	(77, '130301000000', '市辖区', '130300000000'),
	(78, '130302000000', '海港区', '130300000000'),
	(79, '130303000000', '山海关区', '130300000000'),
	(80, '130304000000', '北戴河区', '130300000000'),
	(81, '130306000000', '抚宁区', '130300000000'),
	(82, '130321000000', '青龙满族自治县', '130300000000'),
	(83, '130322000000', '昌黎县', '130300000000'),
	(84, '130324000000', '卢龙县', '130300000000'),
	(85, '130371000000', '秦皇岛市经济技术开发区', '130300000000'),
	(86, '130372000000', '北戴河新区', '130300000000'),
	(87, '130401000000', '市辖区', '130400000000'),
	(88, '130402000000', '邯山区', '130400000000'),
	(89, '130403000000', '丛台区', '130400000000'),
	(90, '130404000000', '复兴区', '130400000000'),
	(91, '130406000000', '峰峰矿区', '130400000000'),
	(92, '130407000000', '肥乡区', '130400000000'),
	(93, '130408000000', '永年区', '130400000000'),
	(94, '130423000000', '临漳县', '130400000000'),
	(95, '130424000000', '成安县', '130400000000'),
	(96, '130425000000', '大名县', '130400000000'),
	(97, '130426000000', '涉县', '130400000000'),
	(98, '130427000000', '磁县', '130400000000'),
	(99, '130430000000', '邱县', '130400000000'),
	(100, '130431000000', '鸡泽县', '130400000000'),
	(101, '130432000000', '广平县', '130400000000'),
	(102, '130433000000', '馆陶县', '130400000000'),
	(103, '130434000000', '魏县', '130400000000'),
	(104, '130435000000', '曲周县', '130400000000'),
	(105, '130471000000', '邯郸经济技术开发区', '130400000000'),
	(106, '130473000000', '邯郸冀南新区', '130400000000'),
	(107, '130481000000', '武安市', '130400000000'),
	(108, '130501000000', '市辖区', '130500000000'),
	(109, '130502000000', '桥东区', '130500000000'),
	(110, '130503000000', '桥西区', '130500000000'),
	(111, '130521000000', '邢台县', '130500000000'),
	(112, '130522000000', '临城县', '130500000000'),
	(113, '130523000000', '内丘县', '130500000000'),
	(114, '130524000000', '柏乡县', '130500000000'),
	(115, '130525000000', '隆尧县', '130500000000'),
	(116, '130526000000', '任县', '130500000000'),
	(117, '130527000000', '南和县', '130500000000'),
	(118, '130528000000', '宁晋县', '130500000000'),
	(119, '130529000000', '巨鹿县', '130500000000'),
	(120, '130530000000', '新河县', '130500000000'),
	(121, '130531000000', '广宗县', '130500000000'),
	(122, '130532000000', '平乡县', '130500000000'),
	(123, '130533000000', '威县', '130500000000'),
	(124, '130534000000', '清河县', '130500000000'),
	(125, '130535000000', '临西县', '130500000000'),
	(126, '130571000000', '河北邢台经济开发区', '130500000000'),
	(127, '130581000000', '南宫市', '130500000000'),
	(128, '130582000000', '沙河市', '130500000000'),
	(129, '130601000000', '市辖区', '130600000000'),
	(130, '130602000000', '竞秀区', '130600000000'),
	(131, '130606000000', '莲池区', '130600000000'),
	(132, '130607000000', '满城区', '130600000000'),
	(133, '130608000000', '清苑区', '130600000000'),
	(134, '130609000000', '徐水区', '130600000000'),
	(135, '130623000000', '涞水县', '130600000000'),
	(136, '130624000000', '阜平县', '130600000000'),
	(137, '130626000000', '定兴县', '130600000000'),
	(138, '130627000000', '唐县', '130600000000'),
	(139, '130628000000', '高阳县', '130600000000'),
	(140, '130629000000', '容城县', '130600000000'),
	(141, '130630000000', '涞源县', '130600000000'),
	(142, '130631000000', '望都县', '130600000000'),
	(143, '130632000000', '安新县', '130600000000'),
	(144, '130633000000', '易县', '130600000000'),
	(145, '130634000000', '曲阳县', '130600000000'),
	(146, '130635000000', '蠡县', '130600000000'),
	(147, '130636000000', '顺平县', '130600000000'),
	(148, '130637000000', '博野县', '130600000000'),
	(149, '130638000000', '雄县', '130600000000'),
	(150, '130671000000', '保定高新技术产业开发区', '130600000000'),
	(151, '130672000000', '保定白沟新城', '130600000000'),
	(152, '130681000000', '涿州市', '130600000000'),
	(153, '130682000000', '定州市', '130600000000'),
	(154, '130683000000', '安国市', '130600000000'),
	(155, '130684000000', '高碑店市', '130600000000'),
	(156, '130701000000', '市辖区', '130700000000'),
	(157, '130702000000', '桥东区', '130700000000'),
	(158, '130703000000', '桥西区', '130700000000'),
	(159, '130705000000', '宣化区', '130700000000'),
	(160, '130706000000', '下花园区', '130700000000'),
	(161, '130708000000', '万全区', '130700000000'),
	(162, '130709000000', '崇礼区', '130700000000'),
	(163, '130722000000', '张北县', '130700000000'),
	(164, '130723000000', '康保县', '130700000000'),
	(165, '130724000000', '沽源县', '130700000000'),
	(166, '130725000000', '尚义县', '130700000000'),
	(167, '130726000000', '蔚县', '130700000000'),
	(168, '130727000000', '阳原县', '130700000000'),
	(169, '130728000000', '怀安县', '130700000000'),
	(170, '130730000000', '怀来县', '130700000000'),
	(171, '130731000000', '涿鹿县', '130700000000'),
	(172, '130732000000', '赤城县', '130700000000'),
	(173, '130771000000', '张家口市高新技术产业开发区', '130700000000'),
	(174, '130772000000', '张家口市察北管理区', '130700000000'),
	(175, '130773000000', '张家口市塞北管理区', '130700000000'),
	(176, '130801000000', '市辖区', '130800000000'),
	(177, '130802000000', '双桥区', '130800000000'),
	(178, '130803000000', '双滦区', '130800000000'),
	(179, '130804000000', '鹰手营子矿区', '130800000000'),
	(180, '130821000000', '承德县', '130800000000'),
	(181, '130822000000', '兴隆县', '130800000000'),
	(182, '130824000000', '滦平县', '130800000000'),
	(183, '130825000000', '隆化县', '130800000000'),
	(184, '130826000000', '丰宁满族自治县', '130800000000'),
	(185, '130827000000', '宽城满族自治县', '130800000000'),
	(186, '130828000000', '围场满族蒙古族自治县', '130800000000'),
	(187, '130871000000', '承德高新技术产业开发区', '130800000000'),
	(188, '130881000000', '平泉市', '130800000000'),
	(189, '130901000000', '市辖区', '130900000000'),
	(190, '130902000000', '新华区', '130900000000'),
	(191, '130903000000', '运河区', '130900000000'),
	(192, '130921000000', '沧县', '130900000000'),
	(193, '130922000000', '青县', '130900000000'),
	(194, '130923000000', '东光县', '130900000000'),
	(195, '130924000000', '海兴县', '130900000000'),
	(196, '130925000000', '盐山县', '130900000000'),
	(197, '130926000000', '肃宁县', '130900000000'),
	(198, '130927000000', '南皮县', '130900000000'),
	(199, '130928000000', '吴桥县', '130900000000'),
	(200, '130929000000', '献县', '130900000000'),
	(201, '130930000000', '孟村回族自治县', '130900000000'),
	(202, '130971000000', '河北沧州经济开发区', '130900000000'),
	(203, '130972000000', '沧州高新技术产业开发区', '130900000000'),
	(204, '130973000000', '沧州渤海新区', '130900000000'),
	(205, '130981000000', '泊头市', '130900000000'),
	(206, '130982000000', '任丘市', '130900000000'),
	(207, '130983000000', '黄骅市', '130900000000'),
	(208, '130984000000', '河间市', '130900000000'),
	(209, '131001000000', '市辖区', '131000000000'),
	(210, '131002000000', '安次区', '131000000000'),
	(211, '131003000000', '广阳区', '131000000000'),
	(212, '131022000000', '固安县', '131000000000'),
	(213, '131023000000', '永清县', '131000000000'),
	(214, '131024000000', '香河县', '131000000000'),
	(215, '131025000000', '大城县', '131000000000'),
	(216, '131026000000', '文安县', '131000000000'),
	(217, '131028000000', '大厂回族自治县', '131000000000'),
	(218, '131071000000', '廊坊经济技术开发区', '131000000000'),
	(219, '131081000000', '霸州市', '131000000000'),
	(220, '131082000000', '三河市', '131000000000'),
	(221, '131101000000', '市辖区', '131100000000'),
	(222, '131102000000', '桃城区', '131100000000'),
	(223, '131103000000', '冀州区', '131100000000'),
	(224, '131121000000', '枣强县', '131100000000'),
	(225, '131122000000', '武邑县', '131100000000'),
	(226, '131123000000', '武强县', '131100000000'),
	(227, '131124000000', '饶阳县', '131100000000'),
	(228, '131125000000', '安平县', '131100000000'),
	(229, '131126000000', '故城县', '131100000000'),
	(230, '131127000000', '景县', '131100000000'),
	(231, '131128000000', '阜城县', '131100000000'),
	(232, '131171000000', '河北衡水经济开发区', '131100000000'),
	(233, '131172000000', '衡水滨湖新区', '131100000000'),
	(234, '131182000000', '深州市', '131100000000'),
	(235, '140101000000', '市辖区', '140100000000'),
	(236, '140105000000', '小店区', '140100000000'),
	(237, '140106000000', '迎泽区', '140100000000'),
	(238, '140107000000', '杏花岭区', '140100000000'),
	(239, '140108000000', '尖草坪区', '140100000000'),
	(240, '140109000000', '万柏林区', '140100000000'),
	(241, '140110000000', '晋源区', '140100000000'),
	(242, '140121000000', '清徐县', '140100000000'),
	(243, '140122000000', '阳曲县', '140100000000'),
	(244, '140123000000', '娄烦县', '140100000000'),
	(245, '140171000000', '山西转型综合改革示范区', '140100000000'),
	(246, '140181000000', '古交市', '140100000000'),
	(247, '140201000000', '市辖区', '140200000000'),
	(248, '140202000000', '城区', '140200000000'),
	(249, '140203000000', '矿区', '140200000000'),
	(250, '140211000000', '南郊区', '140200000000'),
	(251, '140212000000', '新荣区', '140200000000'),
	(252, '140221000000', '阳高县', '140200000000'),
	(253, '140222000000', '天镇县', '140200000000'),
	(254, '140223000000', '广灵县', '140200000000'),
	(255, '140224000000', '灵丘县', '140200000000'),
	(256, '140225000000', '浑源县', '140200000000'),
	(257, '140226000000', '左云县', '140200000000'),
	(258, '140227000000', '大同县', '140200000000'),
	(259, '140271000000', '山西大同经济开发区', '140200000000');
/*!40000 ALTER TABLE `fix_district` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.fix_province
...
-- Dumping data for table db_quick_app.fix_province: 0 rows
DELETE FROM `fix_province`;
/*!40000 ALTER TABLE `fix_province` DISABLE KEYS */;
/*!40000 ALTER TABLE `fix_province` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.fix_town
...
-- Dumping data for table db_quick_app.fix_town: 0 rows
DELETE FROM `fix_town`;
/*!40000 ALTER TABLE `fix_town` DISABLE KEYS */;
/*!40000 ALTER TABLE `fix_town` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.fix_village
...
-- Dumping data for table db_quick_app.fix_village: 0 rows
DELETE FROM `fix_village`;
/*!40000 ALTER TABLE `fix_village` DISABLE KEYS */;
/*!40000 ALTER TABLE `fix_village` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.log_login
...
INSERT INTO `log_login` (`id`, `log_name`, `create_user`, `create_date`, `succeed`, `message`, `ip`) VALUES
	(8, '用户登录', 'admin', '2018-08-24 20:05:19', 'true', '用户登录成功!', '127.0.0.1'),
	(9, '用户登录', 'admin', '2018-08-24 20:08:11', 'true', '用户登录成功!', '127.0.0.1'),
	(10, '用户登录', 'admin', '2018-08-24 20:13:59', 'true', '用户登录成功!', '127.0.0.1'),
	(11, '用户登录', 'admin', '2018-08-24 20:14:08', 'true', '用户登录成功!', '127.0.0.1'),
	(12, '用户登录', 'admin', '2018-08-24 20:19:05', 'true', '用户登录成功!', '127.0.0.1'),
	(13, '用户登录', 'admin', '2018-08-24 20:20:04', 'true', '用户登录成功!', '127.0.0.1'),
	(14, '用户登录', 'admin', '2018-08-24 20:22:00', 'false', '用户名或密码错误!', '127.0.0.1'),
	(15, '用户登录', 'admin', '2018-08-24 20:23:40', 'true', '用户登录成功!', '127.0.0.1'),
	(16, '用户登录', 'null', '2018-08-24 20:28:14', 'false', '用户名或密码错误!', '127.0.0.1'),
	(17, '用户登录', 'null', '2018-08-24 20:28:19', 'false', '用户名或密码错误!', '127.0.0.1'),
	(18, '用户登录', 'null', '2018-08-24 20:29:16', 'false', '用户名或密码错误!', '127.0.0.1'),
	(19, '用户登录', 'null', '2018-08-24 20:47:09', 'false', '用户名或密码错误!', '127.0.0.1'),
	(20, '用户登录', 'null', '2018-08-24 20:47:25', 'false', '用户名或密码错误!', '127.0.0.1'),
	(21, '用户登录', 'null', '2018-08-24 20:48:03', 'false', '用户名或密码错误!', '127.0.0.1'),
	(22, '用户登录', 'null', '2018-08-24 20:49:54', 'false', '用户名或密码错误!', '127.0.0.1'),
	(23, '用户登录', 'null', '2018-08-24 20:50:06', 'false', '用户名或密码错误!', '127.0.0.1'),
	(24, '用户登录', 'null', '2018-08-24 20:50:19', 'true', '用户登录成功!', '127.0.0.1'),
	(25, '用户登录', '22222222', '2018-08-24 20:58:00', 'false', '用户名或密码错误!', '127.0.0.1'),
	(26, '用户登录', '22222222', '2018-08-24 21:04:28', 'false', '用户名或密码错误!', '127.0.0.1'),
	(27, '用户登录', 'admin', '2018-08-24 21:04:31', 'true', '用户登录成功!', '127.0.0.1'),
	(28, '用户登录', 'admin', '2018-08-24 21:09:22', 'true', '用户登录成功!', '127.0.0.1'),
	(29, '用户登录', 'admin', '2018-08-24 21:12:14', 'true', '用户登录成功!', '127.0.0.1'),
	(30, '用户登录', 'admin', '2018-08-24 21:12:19', 'true', '用户登录成功!', '127.0.0.1'),
	(31, '用户登录', 'admin', '2018-08-24 21:13:13', 'true', '用户登录成功!', '127.0.0.1'),
	(32, '用户登录', 'admin', '2018-08-24 21:13:48', 'true', '用户登录成功!', '127.0.0.1'),
	(33, '用户登录', 'admin', '2018-08-24 21:14:57', 'true', '用户登录成功!', '127.0.0.1'),
	(34, '用户登录', 'admin', '2018-08-24 21:17:11', 'true', '用户登录成功!', '127.0.0.1'),
	(35, '用户登录', 'admin', '2018-08-24 21:21:51', 'true', '用户登录成功!', '127.0.0.1'),
	(36, '用户登录', 'admin', '2018-08-24 21:23:00', 'true', '用户登录成功!', '127.0.0.1'),
	(37, '用户登录', 'admin', '2018-08-24 21:25:39', 'true', '用户登录成功!', '127.0.0.1'),
	(38, '用户登录', 'admin', '2018-08-25 10:31:05', 'true', '用户登录成功!', '127.0.0.1'),
	(39, '用户登录', 'admin', '2018-08-25 10:35:32', 'true', '用户登录成功!', '127.0.0.1'),
	(40, '用户登录', 'admin', '2018-08-25 10:45:25', 'true', '用户登录成功!', '127.0.0.1'),
	(41, '用户登录', 'admin', '2018-08-25 10:46:32', 'true', '用户登录成功!', '127.0.0.1'),
	(42, '用户登录', 'admin', '2018-08-25 10:57:42', 'true', '用户登录成功!', '127.0.0.1'),
	(43, '用户登录', 'admin', '2018-08-25 11:01:44', 'true', '用户登录成功!', '127.0.0.1'),
	(44, '用户登录', 'admin', '2018-08-25 11:01:56', 'true', '用户登录成功!', '127.0.0.1'),
	(45, '用户登录', 'admin', '2018-08-25 11:03:17', 'true', '用户登录成功!', '127.0.0.1'),
	(46, '用户登录', 'admin', '2018-08-25 11:05:18', 'true', '用户登录成功!', '127.0.0.1'),
	(47, '用户登录', 'admin', '2018-08-25 11:09:26', 'true', '用户登录成功!', '127.0.0.1'),
	(48, '用户登录', 'admin', '2018-08-25 11:11:18', 'true', '用户登录成功!', '127.0.0.1'),
	(49, '用户登录', 'admin', '2018-08-25 11:16:46', 'true', '用户登录成功!', '127.0.0.1'),
	(50, '用户登录', 'admin', '2018-08-25 11:21:21', 'true', '用户登录成功!', '127.0.0.1'),
	(51, '用户登录', 'admin', '2018-08-25 11:25:51', 'true', '用户登录成功!', '127.0.0.1'),
	(52, '用户登录', 'admin', '2018-08-25 11:26:15', 'true', '用户登录成功!', '127.0.0.1'),
	(53, '用户登录', 'admin', '2018-08-25 12:27:06', 'true', '用户登录成功!', '127.0.0.1'),
	(54, '用户登录', 'admin', '2018-08-25 12:32:28', 'true', '用户登录成功!', '127.0.0.1'),
	(55, '用户登录', 'admin', '2018-08-25 12:32:42', 'true', '用户登录成功!', '127.0.0.1'),
	(56, '用户登录', 'admin', '2018-08-25 12:33:57', 'true', '用户登录成功!', '127.0.0.1'),
	(57, '用户登录', 'admin', '2018-08-25 12:40:57', 'true', '用户登录成功!', '127.0.0.1'),
	(58, '用户登录', 'admin', '2018-08-25 12:44:20', 'true', '用户登录成功!', '127.0.0.1'),
	(59, '用户登录', 'admin', '2018-08-25 12:45:19', 'true', '用户登录成功!', '127.0.0.1'),
	(60, '用户登录', 'admin', '2018-08-25 12:50:10', 'true', '用户登录成功!', '127.0.0.1'),
	(61, '用户登录', 'admin', '2018-08-25 12:51:39', 'true', '用户登录成功!', '127.0.0.1'),
	(62, '用户登录', 'admin', '2018-08-25 12:56:26', 'true', '用户登录成功!', '127.0.0.1'),
	(63, '用户登录', 'admin', '2018-08-25 12:59:02', 'true', '用户登录成功!', '127.0.0.1'),
	(64, '用户登录', 'admin', '2018-08-25 13:31:53', 'true', '用户登录成功!', '127.0.0.1'),
	(65, '用户登录', 'admin', '2018-08-25 13:37:16', 'true', '用户登录成功!', '127.0.0.1'),
	(66, '用户登录', 'admin', '2018-08-25 13:40:22', 'true', '用户登录成功!', '127.0.0.1'),
	(67, '用户登录', 'admin', '2018-08-25 13:43:13', 'true', '用户登录成功!', '127.0.0.1'),
	(68, '用户登录', 'admin', '2018-08-25 13:45:15', 'true', '用户登录成功!', '127.0.0.1'),
	(69, '用户登录', 'admin', '2018-08-25 14:17:38', 'true', '用户登录成功!', '127.0.0.1'),
	(70, '用户登录', 'admin', '2018-08-25 14:23:38', 'true', '用户登录成功!', '127.0.0.1'),
	(71, '用户登录', 'admin', '2018-08-25 14:25:43', 'true', '用户登录成功!', '127.0.0.1'),
	(72, '用户登录', 'admin', '2018-08-25 14:27:14', 'true', '用户登录成功!', '127.0.0.1'),
	(73, '用户登录', 'admin', '2018-08-25 14:54:06', 'true', '用户登录成功!', '127.0.0.1'),
	(74, '用户登录', 'admin', '2018-08-25 14:56:47', 'true', '用户登录成功!', '127.0.0.1'),
	(75, '用户登录', 'admin', '2018-08-25 14:57:45', 'true', '用户登录成功!', '192.168.56.1'),
	(76, '用户登录', 'admin', '2018-08-25 15:09:58', 'true', '用户登录成功!', '127.0.0.1'),
	(77, '用户登录', 'admin', '2018-08-25 15:19:02', 'true', '用户登录成功!', '127.0.0.1'),
	(78, '用户登录', 'admin', '2018-08-25 15:20:11', 'true', '用户登录成功!', '127.0.0.1'),
	(79, '用户登录', 'admin', '2018-08-25 15:25:19', 'true', '用户登录成功!', '192.168.56.1'),
	(80, '用户登录', 'admin', '2018-08-25 15:30:23', 'true', '用户登录成功!', '127.0.0.1'),
	(81, '用户登录', 'admin', '2018-08-25 15:34:01', 'true', '用户登录成功!', '127.0.0.1'),
	(82, '用户登录', 'admin', '2018-08-25 15:35:05', 'true', '用户登录成功!', '127.0.0.1'),
	(83, '用户登录', 'admin', '2018-08-25 15:38:39', 'true', '用户登录成功!', '127.0.0.1'),
	(84, '用户登录', 'admin', '2018-08-25 15:40:01', 'true', '用户登录成功!', '127.0.0.1'),
	(85, '用户登录', 'admin', '2018-08-25 15:53:03', 'true', '用户登录成功!', '127.0.0.1'),
	(86, '用户登录', 'admin', '2018-08-25 16:25:14', 'false', '账户被锁定!', '127.0.0.1'),
	(87, '用户登录', 'admin', '2018-08-25 16:28:05', 'true', '用户登录成功!', '127.0.0.1'),
	(88, '用户登录', 'admin', '2018-08-25 16:32:12', 'true', '用户登录成功!', '127.0.0.1'),
	(89, '用户登录', 'admin', '2018-08-25 16:52:26', 'true', '用户登录成功!', '127.0.0.1'),
	(90, '用户登录', 'admin', '2018-08-25 16:54:26', 'true', '用户登录成功!', '127.0.0.1'),
	(91, '用户登录', 'admin', '2018-08-25 16:57:36', 'true', '用户登录成功!', '127.0.0.1'),
	(92, '用户登录', 'admin', '2018-08-25 17:08:16', 'true', '用户登录成功!', '127.0.0.1'),
	(93, '用户登录', 'admin', '2018-08-25 17:11:37', 'true', '用户登录成功!', '192.168.56.1'),
	(94, '用户登录', 'admin', '2018-08-25 17:15:31', 'true', '用户登录成功!', '127.0.0.1'),
	(95, '用户登录', 'admin', '2018-08-25 17:17:07', 'true', '用户登录成功!', '127.0.0.1'),
	(96, '用户登录', 'admin', '2018-08-25 17:25:48', 'true', '用户登录成功!', '127.0.0.1'),
	(97, '用户登录', 'admin', '2018-08-25 17:29:08', 'true', '用户登录成功!', '127.0.0.1'),
	(98, '用户登录', 'admin', '2018-08-25 17:31:05', 'true', '用户登录成功!', '127.0.0.1'),
	(99, '用户登录', 'admin', '2018-08-25 17:33:13', 'true', '用户登录成功!', '127.0.0.1'),
	(100, '用户登录', 'admin', '2018-08-25 17:37:07', 'true', '用户登录成功!', '127.0.0.1'),
	(101, '用户登录', 'admin', '2018-08-25 17:37:50', 'true', '用户登录成功!', '127.0.0.1'),
	(102, '用户登录', 'admin', '2018-08-25 17:39:43', 'true', '用户登录成功!', '127.0.0.1'),
	(103, '用户登录', 'admin', '2018-08-25 17:43:56', 'true', '用户登录成功!', '127.0.0.1'),
	(104, '用户登录', 'admin', '2018-08-26 10:08:51', 'true', '用户登录成功!', '127.0.0.1'),
	(105, '用户登录', 'admin', '2018-08-26 10:10:56', 'true', '用户登录成功!', '127.0.0.1'),
	(106, '用户登录', 'admin', '2018-08-26 10:12:18', 'true', '用户登录成功!', '127.0.0.1'),
	(107, '用户登录', 'admin', '2018-08-26 10:13:21', 'true', '用户登录成功!', '127.0.0.1'),
	(108, '用户登录', 'admin', '2018-08-26 10:16:23', 'true', '用户登录成功!', '127.0.0.1'),
	(109, '用户登录', 'admin', '2018-08-26 10:21:44', 'true', '用户登录成功!', '127.0.0.1'),
	(110, '用户登录', 'admin', '2018-08-26 10:26:13', 'true', '用户登录成功!', '127.0.0.1'),
	(111, '用户登录', 'admin', '2018-08-26 10:28:43', 'true', '用户登录成功!', '127.0.0.1'),
	(112, '用户登录', 'admin', '2018-08-26 10:33:14', 'true', '用户登录成功!', '127.0.0.1'),
	(113, '用户登录', 'admin', '2018-08-26 10:34:31', 'true', '用户登录成功!', '127.0.0.1'),
	(114, '用户登录', 'admin', '2018-08-26 10:36:26', 'true', '用户登录成功!', '127.0.0.1'),
	(115, '用户登录', 'admin', '2018-08-26 10:38:24', 'true', '用户登录成功!', '127.0.0.1'),
	(116, '用户登录', 'admin', '2018-08-26 10:40:46', 'true', '用户登录成功!', '127.0.0.1'),
	(117, '用户登录', 'admin', '2018-08-26 10:40:52', 'true', '用户登录成功!', '127.0.0.1'),
	(118, '用户登录', 'admin22', '2018-08-26 10:41:10', 'false', '用户名或密码错误!', '127.0.0.1'),
	(119, '用户登录', 'admin', '2018-08-26 10:41:14', 'true', '用户登录成功!', '127.0.0.1'),
	(120, '用户登录', 'admin', '2018-08-26 10:42:36', 'true', '用户登录成功!', '127.0.0.1'),
	(121, '用户登录', 'admin', '2018-08-26 13:14:53', 'true', '用户登录成功!', '127.0.0.1'),
	(122, '用户登录', 'admin', '2018-08-26 13:16:29', 'true', '用户登录成功!', '127.0.0.1'),
	(123, '用户登录', 'admin', '2018-08-26 13:18:04', 'true', '用户登录成功!', '127.0.0.1'),
	(124, '用户登录', 'admin', '2018-08-26 13:25:33', 'true', '用户登录成功!', '127.0.0.1'),
	(125, '用户登录', 'admin', '2018-08-26 13:27:47', 'true', '用户登录成功!', '127.0.0.1'),
	(126, '用户登录', 'admin', '2018-08-26 14:04:51', 'false', '用户名或密码错误!', '127.0.0.1'),
	(127, '用户登录', 'admin', '2018-08-26 14:04:59', 'false', '用户名或密码错误!', '127.0.0.1'),
	(128, '用户登录', 'admin', '2018-08-26 14:06:45', 'true', '用户登录成功!', '127.0.0.1'),
	(129, '用户登录', 'admin', '2018-08-26 14:13:42', 'true', '用户登录成功!', '127.0.0.1'),
	(130, '用户登录', 'admin', '2018-08-26 14:20:08', 'true', '用户登录成功!', '127.0.0.1'),
	(131, '用户登录', 'admin', '2018-08-26 14:34:04', 'true', '用户登录成功!', '127.0.0.1'),
	(132, '用户登录', 'admin', '2018-08-26 14:37:46', 'true', '用户登录成功!', '127.0.0.1'),
	(133, '用户登录', 'admin', '2018-08-26 14:40:17', 'true', '用户登录成功!', '127.0.0.1'),
	(134, '用户登录', 'admin', '2018-08-26 14:44:55', 'true', '用户登录成功!', '127.0.0.1'),
	(135, '用户登录', 'admin', '2018-08-26 14:47:48', 'true', '用户登录成功!', '192.168.56.1'),
	(136, '用户登录', 'admin', '2018-08-26 14:49:31', 'true', '用户登录成功!', '127.0.0.1'),
	(137, '用户登录', 'admin', '2018-08-28 19:20:16', 'true', '用户登录成功!', '127.0.0.1'),
	(138, '用户登录', 'admin', '2018-08-28 19:58:39', 'false', '用户已在线!', '127.0.0.1'),
	(139, '用户登录', 'admin', '2018-08-28 19:58:45', 'true', '用户登录成功!', '127.0.0.1'),
	(140, '用户登录', 'admin', '2018-08-28 20:04:58', 'false', '用户已在线!', '127.0.0.1'),
	(141, '用户登录', 'admin', '2018-08-28 20:05:03', 'true', '用户登录成功!', '127.0.0.1'),
	(142, '用户登录', 'admin', '2018-08-28 20:06:04', 'false', '用户已在线!', '127.0.0.1'),
	(143, '用户登录', 'admin', '2018-08-28 20:06:10', 'true', '用户登录成功!', '127.0.0.1'),
	(144, '用户登录', 'admin', '2018-08-28 20:12:35', 'false', '用户已在线!', '127.0.0.1'),
	(145, '用户登录', 'admin', '2018-08-28 20:12:41', 'true', '用户登录成功!', '127.0.0.1'),
	(146, '用户登录', 'admin', '2018-08-28 20:13:51', 'false', '用户已在线!', '127.0.0.1'),
	(147, '用户登录', 'admin', '2018-08-28 20:13:57', 'true', '用户登录成功!', '127.0.0.1'),
	(148, '用户登录', 'admin', '2018-08-28 20:17:14', 'false', '用户已在线!', '127.0.0.1'),
	(149, '用户登录', 'admin', '2018-08-28 20:17:19', 'true', '用户登录成功!', '127.0.0.1'),
	(150, '用户登录', 'admin', '2018-08-28 20:18:23', 'false', '用户已在线!', '127.0.0.1'),
	(151, '用户登录', 'admin', '2018-08-28 20:18:28', 'true', '用户登录成功!', '127.0.0.1'),
	(152, '用户登录', 'admin', '2018-08-28 20:35:06', 'false', '用户已在线!', '127.0.0.1'),
	(153, '用户登录', 'admin', '2018-08-28 20:35:12', 'true', '用户登录成功!', '127.0.0.1'),
	(154, '用户登录', 'admin', '2018-08-28 20:39:02', 'false', '用户已在线!', '127.0.0.1'),
	(155, '用户登录', 'admin', '2018-08-28 20:39:06', 'true', '用户登录成功!', '127.0.0.1'),
	(156, '用户登录', 'admin', '2018-08-28 20:42:13', 'false', '用户已在线!', '127.0.0.1'),
	(157, '用户登录', 'admin', '2018-08-28 20:42:18', 'true', '用户登录成功!', '127.0.0.1'),
	(158, '用户登录', 'admin', '2018-08-28 20:58:44', 'false', '用户已在线!', '127.0.0.1'),
	(159, '用户登录', 'admin', '2018-08-28 20:58:57', 'true', '用户登录成功!', '127.0.0.1'),
	(160, '用户登录', 'admin', '2018-08-28 21:04:04', 'false', '用户已在线!', '127.0.0.1'),
	(161, '用户登录', 'admin', '2018-08-28 21:04:10', 'true', '用户登录成功!', '127.0.0.1'),
	(162, '用户登录', 'admin', '2018-08-29 09:10:42', 'false', '用户已在线!', '127.0.0.1'),
	(163, '用户登录', 'admin', '2018-08-29 09:10:43', 'false', '用户已在线!', '127.0.0.1'),
	(164, '用户登录', 'admin', '2018-08-29 09:10:49', 'true', '用户登录成功!', '127.0.0.1'),
	(165, '用户登录', 'admin', '2018-08-29 10:11:05', 'false', '用户已在线!', '127.0.0.1'),
	(166, '用户登录', 'admin', '2018-08-29 10:11:11', 'true', '用户登录成功!', '127.0.0.1'),
	(167, '用户登录', 'admin', '2018-08-29 10:33:54', 'false', '用户已在线!', '127.0.0.1'),
	(168, '用户登录', 'admin', '2018-08-29 10:34:02', 'true', '用户登录成功!', '127.0.0.1'),
	(169, '用户登录', 'admin', '2018-08-29 11:05:07', 'false', '用户已在线!', '127.0.0.1'),
	(170, '用户登录', 'admin', '2018-08-29 11:05:13', 'true', '用户登录成功!', '127.0.0.1'),
	(171, '用户登录', 'admin', '2018-08-29 11:08:20', 'false', '用户已在线!', '127.0.0.1'),
	(172, '用户登录', 'admin', '2018-08-29 11:08:27', 'true', '用户登录成功!', '127.0.0.1'),
	(173, '用户登录', 'admin', '2018-08-29 11:10:18', 'false', '用户已在线!', '127.0.0.1'),
	(174, '用户登录', 'admin', '2018-08-29 11:10:47', 'true', '用户登录成功!', '127.0.0.1'),
	(175, '用户登录', 'admin', '2018-08-29 11:13:41', 'false', '用户已在线!', '127.0.0.1'),
	(176, '用户登录', 'admin', '2018-08-29 11:13:46', 'true', '用户登录成功!', '127.0.0.1'),
	(177, '用户登录', 'admin', '2018-08-29 11:15:04', 'false', '用户已在线!', '127.0.0.1'),
	(178, '用户登录', 'admin', '2018-08-29 11:15:10', 'true', '用户登录成功!', '127.0.0.1'),
	(179, '用户登录', 'admin', '2018-08-29 11:23:02', 'false', '用户已在线!', '127.0.0.1'),
	(180, '用户登录', 'admin', '2018-08-29 11:23:08', 'true', '用户登录成功!', '127.0.0.1'),
	(181, '用户登录', 'admin', '2018-08-29 11:55:21', 'false', '用户已在线!', '127.0.0.1'),
	(182, '用户登录', 'admin', '2018-08-29 11:55:28', 'true', '用户登录成功!', '127.0.0.1'),
	(183, '用户登录', 'admin', '2018-08-29 12:34:54', 'false', '用户已在线!', '127.0.0.1'),
	(184, '用户登录', 'admin', '2018-08-29 12:37:28', 'true', '用户登录成功!', '127.0.0.1'),
	(185, '用户登录', 'admin', '2018-08-29 12:44:32', 'false', '用户已在线!', '127.0.0.1'),
	(186, '用户登录', 'admin', '2018-08-29 12:45:03', 'true', '用户登录成功!', '127.0.0.1'),
	(187, '用户登录', 'admin', '2018-08-29 12:48:58', 'false', '用户已在线!', '127.0.0.1'),
	(188, '用户登录', 'admin', '2018-08-29 12:49:04', 'true', '用户登录成功!', '127.0.0.1'),
	(189, '用户登录', 'admin', '2018-08-29 13:04:29', 'false', '用户已在线!', '127.0.0.1'),
	(190, '用户登录', 'admin', '2018-08-29 13:04:36', 'true', '用户登录成功!', '127.0.0.1'),
	(191, '用户登录', 'admin', '2018-08-29 13:36:26', 'false', '用户已在线!', '127.0.0.1'),
	(192, '用户登录', 'admin', '2018-08-29 13:36:35', 'true', '用户登录成功!', '127.0.0.1'),
	(193, '用户登录', 'admin', '2018-08-29 13:49:05', 'false', '用户已在线!', '127.0.0.1'),
	(194, '用户登录', 'admin', '2018-08-29 13:49:19', 'true', '用户登录成功!', '127.0.0.1'),
	(195, '用户登录', 'admin', '2018-08-29 14:20:04', 'false', '用户已在线!', '127.0.0.1'),
	(196, '用户登录', 'admin', '2018-08-29 14:20:12', 'true', '用户登录成功!', '127.0.0.1'),
	(197, '用户登录', 'admin', '2018-08-29 15:06:51', 'false', '用户已在线!', '127.0.0.1'),
	(198, '用户登录', 'admin', '2018-08-29 15:06:57', 'true', '用户登录成功!', '127.0.0.1'),
	(199, '用户登录', 'admin', '2018-08-29 15:19:11', 'false', '用户已在线!', '127.0.0.1'),
	(200, '用户登录', 'admin', '2018-08-29 15:19:18', 'true', '用户登录成功!', '127.0.0.1'),
	(201, '用户登录', 'admin', '2018-08-29 15:22:29', 'false', '用户已在线!', '127.0.0.1'),
	(202, '用户登录', 'admin', '2018-08-29 15:22:36', 'true', '用户登录成功!', '127.0.0.1'),
	(203, '用户登录', 'admin', '2018-08-29 15:45:55', 'false', '用户已在线!', '127.0.0.1'),
	(204, '用户登录', 'admin', '2018-08-29 15:46:19', 'true', '用户登录成功!', '127.0.0.1'),
	(205, '用户登录', 'admin', '2018-08-29 15:50:23', 'false', '用户已在线!', '127.0.0.1'),
	(206, '用户登录', 'admin', '2018-08-29 15:50:30', 'true', '用户登录成功!', '127.0.0.1'),
	(207, '用户登录', 'admin', '2018-08-29 15:52:16', 'false', '用户已在线!', '127.0.0.1'),
	(208, '用户登录', 'admin', '2018-08-29 15:52:26', 'true', '用户登录成功!', '127.0.0.1'),
	(209, '用户登录', 'admin', '2018-08-29 16:00:56', 'false', '用户已在线!', '127.0.0.1'),
	(210, '用户登录', 'admin', '2018-08-29 16:01:05', 'true', '用户登录成功!', '127.0.0.1'),
	(211, '用户登录', 'admin', '2018-08-29 16:59:37', 'false', '用户已在线!', '127.0.0.1'),
	(212, '用户登录', 'admin', '2018-08-29 16:59:57', 'true', '用户登录成功!', '127.0.0.1'),
	(213, '用户登录', 'admin', '2018-08-29 17:08:49', 'false', '用户已在线!', '127.0.0.1'),
	(214, '用户登录', 'admin', '2018-08-29 17:09:15', 'true', '用户登录成功!', '127.0.0.1'),
	(215, '用户登录', 'admin', '2018-08-29 17:14:45', 'false', '用户已在线!', '127.0.0.1'),
	(216, '用户登录', 'admin', '2018-08-29 17:15:03', 'true', '用户登录成功!', '127.0.0.1'),
	(217, '用户登录', 'admin', '2019-02-25 13:12:25', 'false', '用户名或密码错误!', '127.0.0.1'),
	(218, '用户登录', 'admin', '2019-02-25 13:14:15', 'false', '用户已在线!', '127.0.0.1'),
	(219, '用户登录', 'admin', '2019-02-25 13:14:25', 'true', '用户登录成功!', '127.0.0.1'),
	(220, '用户登录', 'admin', '2019-02-25 13:58:16', 'false', '用户已在线!', '127.0.0.1'),
	(221, '用户登录', 'admin', '2019-02-25 13:58:46', 'true', '用户登录成功!', '127.0.0.1'),
	(222, '用户登录', 'admin', '2019-02-25 14:03:44', 'false', '用户已在线!', '127.0.0.1'),
	(223, '用户登录', 'admin', '2019-02-25 14:03:53', 'true', '用户登录成功!', '127.0.0.1'),
	(224, '用户登录', 'admin', '2019-02-25 14:06:51', 'false', '用户已在线!', '127.0.0.1'),
	(225, '用户登录', 'admin', '2019-02-25 14:07:03', 'true', '用户登录成功!', '127.0.0.1'),
	(226, '用户登录', 'admin', '2019-02-25 14:11:00', 'false', '用户已在线!', '127.0.0.1'),
	(227, '用户登录', 'admin', '2019-02-25 14:11:11', 'true', '用户登录成功!', '127.0.0.1'),
	(228, '用户登录', 'admin', '2019-02-25 14:20:54', 'false', '用户已在线!', '127.0.0.1'),
	(229, '用户登录', 'admin', '2019-02-25 14:21:01', 'true', '用户登录成功!', '127.0.0.1'),
	(230, '用户登录', 'admin', '2019-02-25 14:27:49', 'false', '用户已在线!', '127.0.0.1'),
	(231, '用户登录', 'admin', '2019-02-25 14:27:56', 'true', '用户登录成功!', '127.0.0.1'),
	(232, '用户登录', 'admin', '2019-02-25 14:39:15', 'false', '用户已在线!', '127.0.0.1'),
	(233, '用户登录', 'admin', '2019-02-25 14:39:21', 'true', '用户登录成功!', '127.0.0.1'),
	(234, '用户登录', 'admin', '2019-02-25 14:44:14', 'false', '用户已在线!', '127.0.0.1'),
	(235, '用户登录', 'admin', '2019-02-25 14:44:19', 'true', '用户登录成功!', '127.0.0.1'),
	(236, '用户登录', 'admin', '2019-02-25 14:52:40', 'false', '用户已在线!', '127.0.0.1'),
	(237, '用户登录', 'admin', '2019-02-25 14:52:46', 'true', '用户登录成功!', '127.0.0.1'),
	(238, '用户登录', 'admin', '2019-02-25 14:57:09', 'false', '用户名或密码错误!', '127.0.0.1'),
	(239, '用户登录', 'admin', '2019-02-25 14:57:22', 'false', '用户已在线!', '127.0.0.1'),
	(240, '用户登录', 'admin', '2019-02-25 14:57:37', 'true', '用户登录成功!', '127.0.0.1'),
	(241, '用户登录', 'admin', '2019-02-25 15:00:52', 'false', '用户已在线!', '127.0.0.1'),
	(242, '用户登录', 'admin', '2019-02-25 15:01:05', 'false', '用户名或密码错误!', '127.0.0.1'),
	(243, '用户登录', 'admin', '2019-02-25 15:01:09', 'true', '用户登录成功!', '127.0.0.1'),
	(244, '用户登录', 'admin', '2019-02-25 15:19:21', 'false', '用户已在线!', '127.0.0.1'),
	(245, '用户登录', 'admin', '2019-02-25 15:19:33', 'true', '用户登录成功!', '127.0.0.1'),
	(246, '用户登录', 'admin', '2019-02-25 15:38:23', 'false', '用户已在线!', '127.0.0.1'),
	(247, '用户登录', 'admin', '2019-02-25 15:38:28', 'true', '用户登录成功!', '127.0.0.1'),
	(248, '用户登录', 'admin', '2019-02-25 15:43:57', 'false', '用户已在线!', '127.0.0.1'),
	(249, '用户登录', 'admin', '2019-02-25 15:44:02', 'true', '用户登录成功!', '127.0.0.1'),
	(250, '用户登录', 'admin', '2019-02-25 15:46:13', 'false', '用户已在线!', '127.0.0.1'),
	(251, '用户登录', 'admin', '2019-02-25 15:46:18', 'true', '用户登录成功!', '127.0.0.1'),
	(252, '用户登录', 'admin', '2019-02-25 18:11:32', 'false', '用户已在线!', '127.0.0.1'),
	(253, '用户登录', 'admin', '2019-02-25 18:11:42', 'true', '用户登录成功!', '127.0.0.1'),
	(254, '用户登录', 'admin', '2019-02-26 09:34:07', 'false', '用户已在线!', '127.0.0.1'),
	(255, '用户登录', 'admin', '2019-02-26 09:34:27', 'true', '用户登录成功!', '127.0.0.1'),
	(256, '用户登录', 'admin', '2019-02-26 10:07:38', 'false', '用户已在线!', '127.0.0.1'),
	(257, '用户登录', 'admin', '2019-02-26 10:07:45', 'true', '用户登录成功!', '127.0.0.1'),
	(258, '用户登录', 'admin', '2019-02-26 10:14:41', 'false', '用户已在线!', '127.0.0.1'),
	(259, '用户登录', 'admin', '2019-02-26 10:14:46', 'true', '用户登录成功!', '127.0.0.1'),
	(260, '用户登录', 'admin', '2019-02-26 10:16:45', 'false', '用户已在线!', '127.0.0.1'),
	(261, '用户登录', 'admin', '2019-02-26 10:16:50', 'true', '用户登录成功!', '127.0.0.1'),
	(262, '用户登录', 'admin', '2019-02-26 10:18:29', 'false', '用户已在线!', '127.0.0.1'),
	(263, '用户登录', 'admin', '2019-02-26 10:18:34', 'true', '用户登录成功!', '127.0.0.1'),
	(264, '用户登录', 'admin', '2019-02-26 10:20:54', 'false', '用户已在线!', '127.0.0.1'),
	(265, '用户登录', 'admin', '2019-02-26 10:21:01', 'true', '用户登录成功!', '127.0.0.1'),
	(266, '用户登录', 'admin', '2019-02-27 13:47:58', 'false', '用户已在线!', '127.0.0.1'),
	(267, '用户登录', 'admin', '2019-02-27 13:48:04', 'true', '用户登录成功!', '127.0.0.1'),
	(268, '用户登录', 'admin', '2019-02-27 13:51:40', 'false', '用户已在线!', '127.0.0.1'),
	(269, '用户登录', 'admin', '2019-02-27 13:51:46', 'true', '用户登录成功!', '127.0.0.1'),
	(270, '用户登录', 'admin', '2019-02-27 13:54:34', 'false', '用户已在线!', '127.0.0.1'),
	(271, '用户登录', 'admin', '2019-02-27 13:54:39', 'true', '用户登录成功!', '127.0.0.1'),
	(272, '用户登录', 'admin', '2019-02-27 14:03:19', 'false', '用户已在线!', '127.0.0.1'),
	(273, '用户登录', 'admin', '2019-02-27 14:03:26', 'true', '用户登录成功!', '127.0.0.1'),
	(274, '用户登录', 'admin', '2019-02-27 14:06:29', 'false', '用户已在线!', '127.0.0.1'),
	(275, '用户登录', 'admin', '2019-02-27 14:06:35', 'true', '用户登录成功!', '127.0.0.1'),
	(276, '用户登录', 'admin', '2019-02-27 14:17:31', 'false', '用户已在线!', '127.0.0.1'),
	(277, '用户登录', 'admin', '2019-02-27 14:17:37', 'true', '用户登录成功!', '127.0.0.1'),
	(278, '用户登录', 'admin', '2019-02-27 14:36:33', 'false', '用户已在线!', '127.0.0.1'),
	(279, '用户登录', 'admin', '2019-02-27 14:36:57', 'true', '用户登录成功!', '127.0.0.1'),
	(280, '用户登录', 'admin', '2019-02-27 14:40:39', 'false', '用户已在线!', '127.0.0.1'),
	(281, '用户登录', 'admin', '2019-02-27 14:40:45', 'true', '用户登录成功!', '127.0.0.1'),
	(282, '用户登录', 'admin', '2019-02-27 14:41:08', 'false', '用户已在线!', '127.0.0.1'),
	(283, '用户登录', 'admin', '2019-02-27 14:41:13', 'true', '用户登录成功!', '127.0.0.1'),
	(284, '用户登录', 'admin', '2019-02-27 14:47:55', 'false', '用户已在线!', '127.0.0.1'),
	(285, '用户登录', 'admin', '2019-02-27 14:48:00', 'true', '用户登录成功!', '127.0.0.1'),
	(286, '用户登录', 'admin', '2019-02-27 15:05:36', 'false', '用户已在线!', '127.0.0.1'),
	(287, '用户登录', 'admin', '2019-02-27 15:05:44', 'true', '用户登录成功!', '127.0.0.1'),
	(288, '用户登录', 'admin', '2019-02-27 15:26:34', 'false', '用户已在线!', '127.0.0.1'),
	(289, '用户登录', 'admin', '2019-02-27 15:26:41', 'true', '用户登录成功!', '127.0.0.1'),
	(290, '用户登录', 'admin', '2019-02-27 16:28:17', 'false', '用户已在线!', '127.0.0.1'),
	(291, '用户登录', 'admin', '2019-02-27 16:28:32', 'true', '用户登录成功!', '127.0.0.1'),
	(292, '用户登录', 'admin', '2019-02-27 17:08:04', 'false', '用户已在线!', '127.0.0.1'),
	(293, '用户登录', 'admin', '2019-02-27 17:08:24', 'true', '用户登录成功!', '127.0.0.1'),
	(294, '用户登录', 'admin', '2019-02-27 17:21:40', 'false', '用户已在线!', '127.0.0.1'),
	(295, '用户登录', 'admin', '2019-02-27 17:22:03', 'false', '用户已在线!', '127.0.0.1'),
	(296, '用户登录', 'admin', '2019-02-27 17:27:27', 'false', '用户已在线!', '127.0.0.1'),
	(297, '用户登录', 'admin', '2019-02-27 17:27:34', 'false', '用户已在线!', '127.0.0.1'),
	(298, '用户登录', 'admin', '2019-02-27 17:30:23', 'false', '用户已在线!', '127.0.0.1'),
	(299, '用户登录', 'admin', '2019-02-27 17:30:33', 'true', '用户登录成功!', '127.0.0.1'),
	(300, '用户登录', 'admin', '2019-02-28 10:48:22', 'false', '用户已在线!', '127.0.0.1'),
	(301, '用户登录', 'admin', '2019-02-28 10:48:31', 'true', '用户登录成功!', '127.0.0.1'),
	(302, '用户登录', 'admin', '2019-02-28 11:11:18', 'false', '用户已在线!', '127.0.0.1'),
	(303, '用户登录', 'admin', '2019-02-28 11:11:22', 'true', '用户登录成功!', '127.0.0.1'),
	(304, '用户登录', 'admin', '2019-02-28 11:13:11', 'false', '用户已在线!', '127.0.0.1'),
	(305, '用户登录', 'admin', '2019-02-28 11:13:15', 'true', '用户登录成功!', '127.0.0.1'),
	(306, '用户登录', 'admin', '2019-02-28 11:22:06', 'false', '用户已在线!', '127.0.0.1'),
	(307, '用户登录', 'admin', '2019-02-28 11:22:11', 'true', '用户登录成功!', '127.0.0.1'),
	(308, '用户登录', 'admin', '2019-02-28 11:35:59', 'false', '用户已在线!', '127.0.0.1'),
	(309, '用户登录', 'admin', '2019-02-28 11:36:18', 'true', '用户登录成功!', '127.0.0.1'),
	(310, '用户登录', 'admin', '2019-02-28 11:47:13', 'false', '用户已在线!', '127.0.0.1'),
	(311, '用户登录', 'admin', '2019-02-28 11:47:17', 'true', '用户登录成功!', '127.0.0.1'),
	(312, '用户登录', 'admin', '2019-02-28 11:50:29', 'false', '用户已在线!', '127.0.0.1'),
	(313, '用户登录', 'admin', '2019-02-28 11:50:34', 'true', '用户登录成功!', '127.0.0.1'),
	(314, '用户登录', 'admin', '2019-02-28 11:55:46', 'false', '用户名或密码错误!', '127.0.0.1'),
	(315, '用户登录', 'admin', '2019-02-28 11:55:51', 'false', '用户已在线!', '127.0.0.1'),
	(316, '用户登录', 'admin', '2019-02-28 11:55:57', 'true', '用户登录成功!', '127.0.0.1'),
	(317, '用户登录', 'admin', '2019-02-28 11:59:44', 'false', '用户已在线!', '127.0.0.1'),
	(318, '用户登录', 'admin', '2019-02-28 11:59:52', 'true', '用户登录成功!', '127.0.0.1'),
	(319, '用户登录', 'admin', '2019-02-28 12:35:50', 'false', '用户已在线!', '127.0.0.1'),
	(320, '用户登录', 'admin', '2019-02-28 12:35:56', 'true', '用户登录成功!', '127.0.0.1'),
	(321, '用户登录', 'admin', '2019-02-28 12:39:23', 'false', '用户已在线!', '127.0.0.1'),
	(322, '用户登录', 'admin', '2019-02-28 12:39:29', 'true', '用户登录成功!', '127.0.0.1'),
	(323, '用户登录', 'admin', '2019-02-28 13:13:54', 'false', '用户已在线!', '127.0.0.1'),
	(324, '用户登录', 'admin', '2019-02-28 13:14:41', 'true', '用户登录成功!', '127.0.0.1'),
	(325, '用户登录', 'admin', '2019-02-28 13:30:57', 'false', '用户已在线!', '127.0.0.1'),
	(326, '用户登录', 'admin', '2019-02-28 13:31:03', 'true', '用户登录成功!', '127.0.0.1'),
	(327, '用户登录', 'admin', '2019-02-28 13:44:51', 'false', '用户已在线!', '127.0.0.1'),
	(328, '用户登录', 'admin', '2019-02-28 13:44:58', 'true', '用户登录成功!', '127.0.0.1'),
	(329, '用户登录', 'admin', '2019-02-28 13:47:31', 'false', '用户已在线!', '127.0.0.1'),
	(330, '用户登录', 'admin', '2019-02-28 13:47:37', 'true', '用户登录成功!', '127.0.0.1'),
	(331, '用户登录', 'admin', '2019-02-28 13:52:49', 'false', '用户已在线!', '127.0.0.1'),
	(332, '用户登录', 'admin', '2019-02-28 13:52:54', 'true', '用户登录成功!', '127.0.0.1'),
	(333, '用户登录', 'admin', '2019-02-28 13:58:01', 'false', '用户已在线!', '127.0.0.1'),
	(334, '用户登录', 'admin', '2019-02-28 13:58:09', 'true', '用户登录成功!', '127.0.0.1'),
	(335, '用户登录', 'admin', '2019-02-28 14:04:57', 'false', '用户已在线!', '127.0.0.1'),
	(336, '用户登录', 'admin', '2019-02-28 14:05:03', 'true', '用户登录成功!', '127.0.0.1'),
	(337, '用户登录', 'admin', '2019-02-28 14:09:54', 'false', '用户已在线!', '127.0.0.1'),
	(338, '用户登录', 'admin', '2019-02-28 14:09:59', 'true', '用户登录成功!', '127.0.0.1'),
	(339, '用户登录', 'admin', '2019-02-28 14:27:38', 'false', '用户已在线!', '127.0.0.1'),
	(340, '用户登录', 'admin', '2019-02-28 14:27:44', 'true', '用户登录成功!', '127.0.0.1'),
	(341, '用户登录', 'admin', '2019-02-28 14:31:15', 'false', '用户已在线!', '127.0.0.1'),
	(342, '用户登录', 'admin', '2019-02-28 14:31:21', 'true', '用户登录成功!', '127.0.0.1'),
	(343, '用户登录', 'admin', '2019-02-28 14:36:24', 'false', '用户已在线!', '127.0.0.1'),
	(344, '用户登录', 'admin', '2019-02-28 14:36:31', 'true', '用户登录成功!', '127.0.0.1'),
	(345, '用户登录', 'admin', '2019-02-28 14:40:36', 'false', '用户已在线!', '127.0.0.1'),
	(346, '用户登录', 'admin', '2019-02-28 14:40:42', 'true', '用户登录成功!', '127.0.0.1'),
	(347, '用户登录', 'admin', '2019-02-28 14:49:48', 'false', '用户已在线!', '127.0.0.1'),
	(348, '用户登录', 'admin', '2019-02-28 14:49:54', 'true', '用户登录成功!', '127.0.0.1'),
	(349, '用户登录', 'admin', '2019-02-28 15:39:26', 'false', '用户已在线!', '127.0.0.1'),
	(350, '用户登录', 'admin', '2019-02-28 15:39:35', 'true', '用户登录成功!', '127.0.0.1'),
	(351, '用户登录', 'admin', '2019-02-28 15:54:25', 'false', '用户已在线!', '127.0.0.1'),
	(352, '用户登录', 'admin', '2019-02-28 15:55:30', 'false', '用户已在线!', '127.0.0.1'),
	(353, '用户登录', 'admin', '2019-02-28 15:55:31', 'false', '用户已在线!', '127.0.0.1'),
	(354, '用户登录', 'admin', '2019-02-28 15:55:43', 'true', '用户登录成功!', '127.0.0.1'),
	(355, '用户登录', 'admin', '2019-02-28 15:57:30', 'false', '用户已在线!', '127.0.0.1'),
	(356, '用户登录', 'admin', '2019-02-28 15:57:35', 'true', '用户登录成功!', '127.0.0.1'),
	(357, '用户登录', 'admin', '2019-02-28 16:01:28', 'false', '用户已在线!', '127.0.0.1'),
	(358, '用户登录', 'admin', '2019-02-28 16:02:02', 'true', '用户登录成功!', '127.0.0.1'),
	(359, '用户登录', 'admin', '2019-02-28 16:05:42', 'false', '用户已在线!', '127.0.0.1'),
	(360, '用户登录', 'admin', '2019-02-28 16:06:03', 'true', '用户登录成功!', '127.0.0.1'),
	(361, '用户登录', 'admin', '2019-02-28 16:10:36', 'false', '用户已在线!', '127.0.0.1'),
	(362, '用户登录', 'admin', '2019-02-28 16:10:43', 'true', '用户登录成功!', '127.0.0.1'),
	(363, '用户登录', 'admin', '2019-02-28 16:14:24', 'false', '用户已在线!', '127.0.0.1'),
	(364, '用户登录', 'admin', '2019-02-28 16:14:30', 'true', '用户登录成功!', '127.0.0.1'),
	(365, '用户登录', 'admin', '2019-02-28 16:22:11', 'false', '用户已在线!', '127.0.0.1'),
	(366, '用户登录', 'admin', '2019-02-28 16:22:24', 'true', '用户登录成功!', '127.0.0.1'),
	(367, '用户登录', 'admin', '2019-02-28 16:24:11', 'false', '用户已在线!', '127.0.0.1'),
	(368, '用户登录', 'admin', '2019-02-28 16:24:16', 'true', '用户登录成功!', '127.0.0.1'),
	(369, '用户登录', 'admin', '2019-02-28 16:34:01', 'false', '用户已在线!', '127.0.0.1'),
	(370, '用户登录', 'admin', '2019-02-28 16:34:10', 'true', '用户登录成功!', '127.0.0.1'),
	(371, '用户登录', 'admin', '2019-02-28 16:38:51', 'false', '用户已在线!', '127.0.0.1'),
	(372, '用户登录', 'admin', '2019-02-28 16:38:59', 'true', '用户登录成功!', '127.0.0.1'),
	(373, '用户登录', 'admin', '2019-02-28 16:46:58', 'false', '用户已在线!', '127.0.0.1'),
	(374, '用户登录', 'admin', '2019-02-28 16:47:04', 'true', '用户登录成功!', '127.0.0.1'),
	(375, '用户登录', 'admin', '2019-02-28 17:30:07', 'false', '用户已在线!', '127.0.0.1'),
	(376, '用户登录', 'admin', '2019-02-28 17:30:18', 'true', '用户登录成功!', '127.0.0.1'),
	(377, '用户登录', 'admin', '2019-02-28 17:32:10', 'false', '用户已在线!', '127.0.0.1'),
	(378, '用户登录', 'admin', '2019-02-28 17:32:24', 'true', '用户登录成功!', '127.0.0.1'),
	(379, '用户登录', 'admin', '2019-02-28 17:37:28', 'false', '用户已在线!', '127.0.0.1'),
	(380, '用户登录', 'admin', '2019-02-28 17:38:00', 'true', '用户登录成功!', '127.0.0.1'),
	(381, '用户登录', 'admin', '2019-02-28 17:45:54', 'false', '用户已在线!', '127.0.0.1'),
	(382, '用户登录', 'admin', '2019-02-28 17:46:00', 'true', '用户登录成功!', '127.0.0.1'),
	(383, '用户登录', 'admin', '2019-03-01 11:35:12', 'false', '用户已在线!', '127.0.0.1'),
	(384, '用户登录', 'admin', '2019-03-01 11:35:13', 'false', '用户已在线!', '127.0.0.1'),
	(385, '用户登录', 'admin', '2019-03-01 11:35:18', 'true', '用户登录成功!', '127.0.0.1'),
	(386, '用户登录', 'admin', '2019-03-01 11:42:07', 'false', '用户已在线!', '127.0.0.1'),
	(387, '用户登录', 'admin', '2019-03-01 11:42:21', 'true', '用户登录成功!', '127.0.0.1'),
	(388, '用户登录', 'admin', '2019-03-01 11:45:52', 'false', '用户已在线!', '127.0.0.1'),
	(389, '用户登录', 'admin', '2019-03-01 11:46:00', 'true', '用户登录成功!', '127.0.0.1'),
	(390, '用户登录', 'admin', '2019-03-01 11:50:37', 'false', '用户已在线!', '127.0.0.1'),
	(391, '用户登录', 'admin', '2019-03-01 11:50:43', 'true', '用户登录成功!', '127.0.0.1'),
	(392, '用户登录', 'admin', '2019-03-01 11:52:27', 'false', '用户已在线!', '127.0.0.1'),
	(393, '用户登录', 'admin', '2019-03-01 11:52:31', 'true', '用户登录成功!', '127.0.0.1'),
	(394, '用户登录', 'admin', '2019-03-01 11:57:22', 'false', '用户已在线!', '127.0.0.1'),
	(395, '用户登录', 'admin', '2019-03-01 11:57:31', 'true', '用户登录成功!', '127.0.0.1'),
	(396, '用户登录', 'admin', '2019-03-01 13:05:18', 'false', '用户已在线!', '127.0.0.1'),
	(397, '用户登录', 'admin', '2019-03-01 13:05:23', 'true', '用户登录成功!', '127.0.0.1'),
	(398, '用户登录', 'admin', '2019-03-01 13:10:07', 'false', '用户已在线!', '127.0.0.1'),
	(399, '用户登录', 'admin', '2019-03-01 13:10:11', 'true', '用户登录成功!', '127.0.0.1'),
	(400, '用户登录', 'admin', '2019-03-01 13:42:57', 'false', '用户已在线!', '127.0.0.1'),
	(401, '用户登录', 'admin', '2019-03-01 13:43:02', 'true', '用户登录成功!', '127.0.0.1'),
	(402, '用户登录', 'admin', '2019-03-01 13:50:05', 'false', '用户已在线!', '127.0.0.1'),
	(403, '用户登录', 'admin', '2019-03-01 13:50:13', 'true', '用户登录成功!', '127.0.0.1'),
	(404, '用户登录', 'admin', '2019-03-01 13:57:16', 'false', '用户已在线!', '127.0.0.1'),
	(405, '用户登录', 'admin', '2019-03-01 13:57:20', 'true', '用户登录成功!', '127.0.0.1'),
	(406, '用户登录', 'admin', '2019-03-01 14:05:13', 'false', '用户已在线!', '127.0.0.1'),
	(407, '用户登录', 'admin', '2019-03-01 14:05:20', 'true', '用户登录成功!', '127.0.0.1'),
	(408, '用户登录', 'admin', '2019-03-01 14:11:33', 'false', '用户已在线!', '127.0.0.1'),
	(409, '用户登录', 'admin', '2019-03-01 14:11:38', 'true', '用户登录成功!', '127.0.0.1'),
	(410, '用户登录', 'admin', '2019-03-01 14:16:06', 'false', '用户已在线!', '127.0.0.1'),
	(411, '用户登录', 'admin', '2019-03-01 14:16:11', 'true', '用户登录成功!', '127.0.0.1'),
	(412, '用户登录', 'admin', '2019-03-01 14:26:51', 'false', '用户已在线!', '127.0.0.1'),
	(413, '用户登录', 'admin', '2019-03-01 14:26:57', 'true', '用户登录成功!', '127.0.0.1'),
	(414, '用户登录', 'admin', '2019-03-01 15:17:43', 'false', '用户已在线!', '127.0.0.1'),
	(415, '用户登录', 'admin', '2019-03-01 15:17:50', 'true', '用户登录成功!', '127.0.0.1'),
	(416, '用户登录', 'admin', '2019-03-01 15:20:40', 'false', '用户已在线!', '127.0.0.1'),
	(417, '用户登录', 'admin', '2019-03-01 15:20:47', 'true', '用户登录成功!', '127.0.0.1'),
	(418, '用户登录', 'admin', '2019-03-01 15:24:05', 'false', '用户已在线!', '127.0.0.1'),
	(419, '用户登录', 'admin', '2019-03-01 15:24:10', 'true', '用户登录成功!', '127.0.0.1'),
	(420, '用户登录', 'admin', '2019-03-01 15:29:27', 'false', '用户已在线!', '127.0.0.1'),
	(421, '用户登录', 'admin', '2019-03-01 15:29:41', 'true', '用户登录成功!', '127.0.0.1'),
	(422, '用户登录', 'admin', '2019-03-01 15:32:12', 'false', '用户已在线!', '127.0.0.1'),
	(423, '用户登录', 'admin', '2019-03-01 15:32:18', 'true', '用户登录成功!', '127.0.0.1'),
	(424, '用户登录', 'admin', '2019-03-01 16:19:37', 'false', '用户已在线!', '127.0.0.1'),
	(425, '用户登录', 'admin', '2019-03-01 16:19:47', 'true', '用户登录成功!', '127.0.0.1'),
	(426, '用户登录', 'admin', '2019-03-01 16:56:02', 'false', '用户已在线!', '127.0.0.1'),
	(427, '用户登录', 'admin', '2019-03-01 16:57:27', 'true', '用户登录成功!', '127.0.0.1'),
	(428, '用户登录', 'admin', '2019-03-01 17:21:31', 'false', '用户已在线!', '127.0.0.1'),
	(429, '用户登录', 'admin', '2019-03-01 17:21:39', 'true', '用户登录成功!', '127.0.0.1'),
	(430, '用户登录', 'admin', '2019-03-01 17:26:00', 'false', '用户已在线!', '127.0.0.1'),
	(431, '用户登录', 'admin', '2019-03-01 17:26:07', 'true', '用户登录成功!', '127.0.0.1'),
	(432, '用户登录', 'admin', '2019-03-01 17:28:40', 'false', '用户已在线!', '127.0.0.1'),
	(433, '用户登录', 'admin', '2019-03-01 17:28:51', 'true', '用户登录成功!', '127.0.0.1'),
	(434, '用户登录', 'admin', '2019-03-01 17:30:32', 'false', '用户已在线!', '127.0.0.1'),
	(435, '用户登录', 'admin', '2019-03-01 17:30:37', 'true', '用户登录成功!', '127.0.0.1'),
	(436, '用户登录', 'admin', '2019-03-01 17:34:18', 'false', '用户已在线!', '127.0.0.1'),
	(437, '用户登录', 'admin', '2019-03-01 17:34:23', 'true', '用户登录成功!', '127.0.0.1'),
	(438, '用户登录', 'admin', '2019-03-01 17:42:01', 'false', '用户已在线!', '127.0.0.1'),
	(439, '用户登录', 'admin', '2019-03-01 17:42:06', 'true', '用户登录成功!', '127.0.0.1'),
	(440, '用户登录', 'admin', '2019-03-01 17:46:48', 'false', '用户已在线!', '127.0.0.1'),
	(441, '用户登录', 'admin', '2019-03-01 17:46:56', 'true', '用户登录成功!', '127.0.0.1'),
	(442, '用户登录', 'admin', '2019-03-01 17:53:13', 'false', '用户已在线!', '127.0.0.1'),
	(443, '用户登录', 'admin', '2019-03-01 17:53:17', 'true', '用户登录成功!', '127.0.0.1'),
	(444, '用户登录', 'admin', '2019-03-01 17:57:37', 'false', '用户已在线!', '127.0.0.1'),
	(445, '用户登录', 'admin', '2019-03-01 17:57:42', 'true', '用户登录成功!', '127.0.0.1'),
	(446, '用户登录', 'admin', '2019-03-04 13:47:35', 'false', '用户已在线!', '127.0.0.1'),
	(447, '用户登录', 'admin', '2019-03-04 14:20:53', 'true', '用户登录成功!', '127.0.0.1'),
	(448, '用户登录', 'admin', '2019-03-04 15:05:42', 'false', '用户已在线!', '127.0.0.1'),
	(449, '用户登录', 'admin', '2019-03-04 15:06:24', 'true', '用户登录成功!', '127.0.0.1'),
	(450, '用户登录', 'admin', '2019-03-04 15:10:13', 'false', '用户已在线!', '127.0.0.1'),
	(451, '用户登录', 'admin', '2019-03-04 15:19:49', 'false', '用户已在线!', '127.0.0.1'),
	(452, '用户登录', 'admin', '2019-03-04 15:19:58', 'true', '用户登录成功!', '127.0.0.1'),
	(453, '用户登录', 'admin', '2019-03-04 15:24:50', 'false', '用户已在线!', '127.0.0.1'),
	(454, '用户登录', 'admin', '2019-03-04 15:24:56', 'true', '用户登录成功!', '127.0.0.1'),
	(455, '用户登录', 'admin', '2019-03-04 15:30:17', 'false', '用户已在线!', '127.0.0.1'),
	(456, '用户登录', 'admin', '2019-03-04 15:30:23', 'true', '用户登录成功!', '127.0.0.1'),
	(457, '用户登录', 'admin', '2019-03-04 15:33:47', 'false', '用户已在线!', '127.0.0.1'),
	(458, '用户登录', 'admin', '2019-03-04 15:33:54', 'true', '用户登录成功!', '127.0.0.1'),
	(459, '用户登录', 'admin', '2019-03-04 15:57:08', 'false', '用户已在线!', '127.0.0.1'),
	(460, '用户登录', 'admin', '2019-03-04 15:57:22', 'true', '用户登录成功!', '127.0.0.1'),
	(461, '用户登录', 'admin', '2019-03-04 16:00:59', 'false', '用户已在线!', '127.0.0.1'),
	(462, '用户登录', 'admin', '2019-03-04 16:01:21', 'true', '用户登录成功!', '127.0.0.1'),
	(463, '用户登录', 'admin', '2019-03-04 16:14:05', 'false', '用户已在线!', '127.0.0.1'),
	(464, '用户登录', 'admin', '2019-03-04 16:14:14', 'true', '用户登录成功!', '127.0.0.1'),
	(465, '用户登录', 'admin', '2019-03-04 16:22:35', 'false', '用户已在线!', '127.0.0.1'),
	(466, '用户登录', 'admin', '2019-03-04 16:22:40', 'true', '用户登录成功!', '127.0.0.1'),
	(467, '用户登录', 'admin', '2019-03-04 16:30:07', 'false', '用户已在线!', '127.0.0.1'),
	(468, '用户登录', 'admin', '2019-03-04 16:30:17', 'true', '用户登录成功!', '127.0.0.1'),
	(469, '用户登录', 'admin', '2019-03-04 16:34:03', 'false', '用户已在线!', '127.0.0.1'),
	(470, '用户登录', 'admin', '2019-03-04 16:34:12', 'true', '用户登录成功!', '127.0.0.1'),
	(471, '用户登录', 'admin', '2019-03-04 16:43:01', 'false', '用户已在线!', '127.0.0.1'),
	(472, '用户登录', 'admin', '2019-03-04 16:43:43', 'true', '用户登录成功!', '127.0.0.1'),
	(473, '用户登录', 'admin', '2019-03-04 16:49:27', 'false', '用户已在线!', '127.0.0.1'),
	(474, '用户登录', 'admin', '2019-03-04 16:49:35', 'true', '用户登录成功!', '127.0.0.1'),
	(475, '用户登录', 'admin', '2019-03-04 16:55:50', 'false', '用户已在线!', '127.0.0.1'),
	(476, '用户登录', 'admin', '2019-03-04 16:55:56', 'true', '用户登录成功!', '127.0.0.1'),
	(477, '用户登录', 'admin', '2019-03-04 17:05:49', 'false', '用户已在线!', '127.0.0.1'),
	(478, '用户登录', 'admin', '2019-03-04 17:05:56', 'true', '用户登录成功!', '127.0.0.1'),
	(479, '用户登录', 'admin', '2019-03-04 17:11:02', 'false', '用户已在线!', '127.0.0.1'),
	(480, '用户登录', 'admin', '2019-03-04 17:11:09', 'true', '用户登录成功!', '127.0.0.1'),
	(481, '用户登录', 'admin', '2019-03-04 17:23:15', 'false', '用户已在线!', '127.0.0.1'),
	(482, '用户登录', 'admin', '2019-03-04 17:23:22', 'true', '用户登录成功!', '127.0.0.1'),
	(483, '用户登录', 'admin', '2019-03-04 17:33:26', 'false', '用户已在线!', '127.0.0.1'),
	(484, '用户登录', 'admin', '2019-03-04 17:33:38', 'true', '用户登录成功!', '127.0.0.1'),
	(485, '用户登录', 'admin', '2019-03-04 17:37:57', 'false', '用户已在线!', '127.0.0.1'),
	(486, '用户登录', 'admin', '2019-03-04 17:38:07', 'true', '用户登录成功!', '127.0.0.1'),
	(487, '用户登录', 'admin', '2019-03-04 17:42:32', 'false', '用户已在线!', '127.0.0.1'),
	(488, '用户登录', 'admin', '2019-03-04 17:42:38', 'true', '用户登录成功!', '127.0.0.1'),
	(489, '用户登录', 'admin', '2019-03-04 17:50:02', 'false', '用户已在线!', '127.0.0.1'),
	(490, '用户登录', 'admin', '2019-03-04 17:50:19', 'true', '用户登录成功!', '127.0.0.1'),
	(491, '用户登录', 'admin', '2019-03-04 17:57:21', 'false', '用户已在线!', '127.0.0.1'),
	(492, '用户登录', 'admin', '2019-03-04 17:57:51', 'true', '用户登录成功!', '127.0.0.1'),
	(493, '用户登录', 'admin', '2019-03-05 10:41:24', 'false', '用户已在线!', '127.0.0.1'),
	(494, '用户登录', 'admin', '2019-03-05 10:43:05', 'true', '用户登录成功!', '127.0.0.1'),
	(495, '用户登录', 'admin', '2019-03-05 10:51:35', 'false', '用户已在线!', '127.0.0.1'),
	(496, '用户登录', 'admin', '2019-03-05 10:51:40', 'true', '用户登录成功!', '127.0.0.1'),
	(497, '用户登录', 'admin', '2019-03-05 10:58:05', 'false', '用户已在线!', '127.0.0.1'),
	(498, '用户登录', 'admin', '2019-03-05 10:58:10', 'true', '用户登录成功!', '127.0.0.1'),
	(499, '用户登录', 'admin', '2019-03-05 11:13:37', 'false', '用户已在线!', '127.0.0.1'),
	(500, '用户登录', 'admin', '2019-03-05 11:13:41', 'true', '用户登录成功!', '127.0.0.1'),
	(501, '用户登录', 'admin', '2019-03-05 11:15:58', 'false', '用户已在线!', '127.0.0.1'),
	(502, '用户登录', 'admin', '2019-03-05 11:16:06', 'true', '用户登录成功!', '127.0.0.1'),
	(503, '用户登录', 'admin', '2019-03-05 11:21:54', 'false', '用户已在线!', '127.0.0.1'),
	(504, '用户登录', 'admin', '2019-03-05 11:21:59', 'true', '用户登录成功!', '127.0.0.1'),
	(505, '用户登录', 'admin', '2019-03-05 11:26:34', 'false', '用户已在线!', '127.0.0.1'),
	(506, '用户登录', 'admin', '2019-03-05 11:26:40', 'true', '用户登录成功!', '127.0.0.1'),
	(507, '用户登录', 'admin', '2019-03-05 11:41:33', 'false', '用户已在线!', '127.0.0.1'),
	(508, '用户登录', 'admin', '2019-03-05 11:42:07', 'true', '用户登录成功!', '127.0.0.1'),
	(509, '用户登录', 'admin', '2019-03-05 11:45:00', 'false', '用户已在线!', '127.0.0.1'),
	(510, '用户登录', 'admin', '2019-03-05 11:45:05', 'true', '用户登录成功!', '127.0.0.1'),
	(511, '用户登录', 'admin', '2019-03-05 11:57:58', 'false', '用户已在线!', '127.0.0.1'),
	(512, '用户登录', 'admin', '2019-03-05 11:58:02', 'true', '用户登录成功!', '127.0.0.1'),
	(513, '用户登录', 'admin', '2019-03-05 12:45:29', 'false', '用户已在线!', '127.0.0.1'),
	(514, '用户登录', 'admin', '2019-03-05 12:45:37', 'true', '用户登录成功!', '127.0.0.1'),
	(515, '用户登录', 'admin', '2019-03-05 12:59:21', 'false', '用户已在线!', '127.0.0.1'),
	(516, '用户登录', 'admin', '2019-03-05 12:59:26', 'true', '用户登录成功!', '127.0.0.1'),
	(517, '用户登录', 'admin', '2019-03-05 13:07:33', 'false', '用户已在线!', '127.0.0.1'),
	(518, '用户登录', 'admin', '2019-03-05 13:07:38', 'true', '用户登录成功!', '127.0.0.1'),
	(519, '用户登录', 'admin', '2019-03-05 13:39:05', 'false', '用户已在线!', '127.0.0.1'),
	(520, '用户登录', 'admin', '2019-03-05 13:39:11', 'true', '用户登录成功!', '127.0.0.1'),
	(521, '用户登录', 'admin', '2019-03-05 13:47:06', 'false', '用户已在线!', '127.0.0.1'),
	(522, '用户登录', 'admin', '2019-03-05 13:47:13', 'true', '用户登录成功!', '127.0.0.1'),
	(523, '用户登录', 'admin', '2019-03-05 14:04:38', 'false', '用户已在线!', '127.0.0.1'),
	(524, '用户登录', 'admin', '2019-03-05 14:04:43', 'true', '用户登录成功!', '127.0.0.1'),
	(525, '用户登录', 'admin', '2019-03-05 14:10:28', 'false', '用户已在线!', '127.0.0.1'),
	(526, '用户登录', 'admin', '2019-03-05 14:10:32', 'true', '用户登录成功!', '127.0.0.1'),
	(527, '用户登录', 'admin', '2019-03-05 14:17:20', 'false', '用户已在线!', '127.0.0.1'),
	(528, '用户登录', 'admin', '2019-03-05 14:17:24', 'true', '用户登录成功!', '127.0.0.1'),
	(529, '用户登录', 'admin', '2019-03-05 14:19:54', 'false', '用户已在线!', '127.0.0.1'),
	(530, '用户登录', 'admin', '2019-03-05 14:20:00', 'true', '用户登录成功!', '127.0.0.1'),
	(531, '用户登录', 'admin', '2019-03-05 14:22:39', 'false', '用户已在线!', '127.0.0.1'),
	(532, '用户登录', 'admin', '2019-03-05 14:22:46', 'true', '用户登录成功!', '127.0.0.1'),
	(533, '用户登录', 'admin', '2019-03-05 14:43:25', 'false', '用户已在线!', '127.0.0.1'),
	(534, '用户登录', 'admin', '2019-03-05 14:43:41', 'true', '用户登录成功!', '127.0.0.1'),
	(535, '用户登录', 'admin', '2019-03-05 14:47:52', 'false', '用户名或密码错误!', '127.0.0.1'),
	(536, '用户登录', 'admin', '2019-03-05 14:47:58', 'false', '用户已在线!', '127.0.0.1'),
	(537, '用户登录', 'admin', '2019-03-05 14:48:04', 'true', '用户登录成功!', '127.0.0.1'),
	(538, '用户登录', 'admin', '2019-03-05 14:52:32', 'false', '用户已在线!', '127.0.0.1'),
	(539, '用户登录', 'admin', '2019-03-05 14:52:37', 'true', '用户登录成功!', '127.0.0.1'),
	(540, '用户登录', 'admin', '2019-03-05 15:06:22', 'false', '用户已在线!', '127.0.0.1'),
	(541, '用户登录', 'admin', '2019-03-05 15:06:27', 'true', '用户登录成功!', '127.0.0.1'),
	(542, '用户登录', 'admin', '2019-03-05 15:39:46', 'false', '用户已在线!', '127.0.0.1'),
	(543, '用户登录', 'admin', '2019-03-05 15:39:51', 'true', '用户登录成功!', '127.0.0.1'),
	(544, '用户登录', 'admin', '2019-03-05 15:50:02', 'false', '用户已在线!', '127.0.0.1'),
	(545, '用户登录', 'admin', '2019-03-05 15:50:06', 'true', '用户登录成功!', '127.0.0.1'),
	(546, '用户登录', 'admin', '2019-03-05 16:44:24', 'false', '用户已在线!', '127.0.0.1'),
	(547, '用户登录', 'admin', '2019-03-05 16:44:30', 'true', '用户登录成功!', '127.0.0.1'),
	(548, '用户登录', 'admin', '2019-03-05 17:03:48', 'false', '用户已在线!', '127.0.0.1'),
	(549, '用户登录', 'admin', '2019-03-05 17:03:48', 'false', '用户已在线!', '127.0.0.1'),
	(550, '用户登录', 'admin', '2019-03-05 17:03:56', 'true', '用户登录成功!', '127.0.0.1'),
	(551, '用户登录', 'admin', '2019-03-05 17:07:18', 'false', '用户已在线!', '127.0.0.1'),
	(552, '用户登录', 'admin', '2019-03-05 17:07:25', 'true', '用户登录成功!', '127.0.0.1'),
	(553, '用户登录', 'admin', '2019-03-05 17:13:06', 'false', '用户已在线!', '127.0.0.1'),
	(554, '用户登录', 'admin', '2019-03-05 17:13:12', 'true', '用户登录成功!', '127.0.0.1'),
	(555, '用户登录', 'admin', '2019-03-05 17:19:58', 'false', '用户已在线!', '127.0.0.1'),
	(556, '用户登录', 'admin', '2019-03-05 17:20:03', 'true', '用户登录成功!', '127.0.0.1'),
	(557, '用户登录', 'admin', '2019-03-05 17:24:22', 'false', '用户已在线!', '127.0.0.1'),
	(558, '用户登录', 'admin', '2019-03-05 17:24:27', 'true', '用户登录成功!', '127.0.0.1'),
...
-- Dumping structure for テーブル db_quick_app.log_operation
...
-- Dumping data for table db_quick_app.log_operation: ~0 rows (approximately)
DELETE FROM `log_operation`;
/*!40000 ALTER TABLE `log_operation` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_operation` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.sys_contact
...
CREATE TABLE IF NOT EXISTS `sys_contact` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='用户联系信息表';
...
INSERT INTO `sys_contact` (`id`, `user_name`, `contact_type`, `contact_info`, `dis_flag`) VALUES
	(1, 'admin', 1, '33333322', 0),
	(2, 'admin', 2, '333333333', 0),
	(3, 'admin22', 2, '222', 0),
	(4, 'admin', 1, '123@qq.com', 0),
	(5, 'admin', 1, '123@qq.com', 0),
	(14, 'admin', 1, '123@qq.com', 0),
	(15, 'admin', 2, '15092315759', 0),
	(16, 'xxxxx', 2, '15092315759', 0),
	(17, 'xxxxx', 3, '111111111', 0),
	(18, 'xxxxx', 4, '111111111', 0);
/*!40000 ALTER TABLE `sys_contact` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.sys_department
...
-- Dumping data for table db_quick_app.sys_department: ~8 rows (approximately)
DELETE FROM `sys_department`;
/*!40000 ALTER TABLE `sys_department` DISABLE KEYS */;
INSERT INTO `sys_department` (`id`, `code`, `depart_code`, `pcode`, `depart_simple_name`, `depart_full_name`, `depart_leader`, `depart_tel`, `open_flag`, `tips`, `temp`, `num`, `dis_flag`, `create_date`, `update_date`, `create_user`, `update_user`) VALUES
	(1, '1', 'top_department', '0', 'A1', NULL, NULL, NULL, 1, NULL, NULL, 1, 0, '2019-03-01 10:02:52', '2019-03-01 10:02:55', 'admin', 'admin'),
	(2, '2-1', 'B1', '1', 'B1', NULL, NULL, NULL, 0, NULL, NULL, 1, 0, '2019-03-01 10:02:52', '2019-03-01 10:02:55', 'admin', 'admin'),
	(3, '3-1', 'C1', '1', 'C1', NULL, NULL, NULL, 0, NULL, NULL, 1, 0, '2019-03-01 10:02:52', '2019-03-01 10:02:55', 'admin', 'admin'),
	(4, '1-1', 'A12', '1', 'A12', NULL, NULL, NULL, 1, NULL, NULL, 1, 0, '2019-03-01 10:02:52', '2019-03-01 10:02:55', 'admin', 'admin'),
	(5, '2-1-1', 'B21', '2-1', 'B21', NULL, NULL, NULL, 0, NULL, NULL, 1, 0, '2019-03-01 10:02:52', '2019-03-01 10:02:55', 'admin', 'admin'),
	(6, '1-1-2', 'A13', '1-1', 'A13', NULL, NULL, NULL, 0, NULL, NULL, 1, 0, '2019-03-01 10:02:52', '2019-03-01 10:02:55', 'admin', 'admin'),
	(7, '3-1-1', 'b13', '3-1', 'b13', NULL, NULL, NULL, 0, NULL, NULL, 1, 0, '2019-03-01 10:02:52', '2019-03-01 10:02:55', 'admin', 'admin'),
	(8, '1-1-1', 'A14', '1-1', 'A14', NULL, NULL, NULL, 0, NULL, NULL, 1, 0, '2019-03-01 10:02:52', '2019-03-01 10:02:55', 'admin', 'admin');
/*!40000 ALTER TABLE `sys_department` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.sys_dept
...
-- Dumping data for table db_quick_app.sys_dept: ~0 rows (approximately)
DELETE FROM `sys_dept`;
/*!40000 ALTER TABLE `sys_dept` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_dept` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.sys_dictionary
...
-- Dumping data for table db_quick_app.sys_dictionary: ~0 rows (approximately)
DELETE FROM `sys_dictionary`;
/*!40000 ALTER TABLE `sys_dictionary` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_dictionary` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.sys_menu
...
INSERT INTO `sys_menu` (`id`, `code`, `pid`, `menu_real_name`, `icon`, `url`, `num`, `levels`, `menu_flag`, `tips`, `open_flag`, `dis_flag`, `create_date`, `update_date`, `create_user`, `update_user`) VALUES
	(1, 'sys_manager', '0', '系统管理', NULL, NULL, 1, NULL, 1, NULL, 1, 0, '2018-08-26 09:52:48', '2018-08-26 09:52:52', 'admin', 'admin'),
	(2, 'sys_user', '1', '用户管理', NULL, '/systemUserController/list', 1, NULL, 1, NULL, 0, 0, '2018-08-26 09:54:52', '2018-08-26 09:54:54', 'admin', 'admin'),
	(3, 'sys_notice', '0', '通知管理', NULL, NULL, 21, NULL, 1, NULL, 1, 0, '2018-08-26 09:56:06', '2018-08-26 09:56:08', 'admin', 'admin'),
...
-- Dumping structure for テーブル db_quick_app.sys_menu_role
...
-- Dumping structure for テーブル db_quick_app.sys_role
...
-- Dumping data for table db_quick_app.sys_role: ~2 rows (approximately)
...
-- Dumping structure for テーブル db_quick_app.sys_user
...
-- Dumping data for table db_quick_app.sys_user: ~6 rows (approximately)
...
INSERT INTO `sys_user` (`id`, `user_name`, `REAL_NAME`, `avatar`, `sex`, `PASSWORD`, `SALT`, `birthday`, `is_online`, `role_id`, `dept_id`, `dis_flag`, `create_date`, `update_date`, `create_user`, `update_user`) VALUES
	...
	(10, 'xxxxx', 'xxx', '6', 1, 'c7a109f6b4e50b1b99bab74e099e57eb', 'yrnxg', '2019-02-28 00:00:00', 0, NULL, NULL, 0, '2019-03-04 16:35:09', '2019-03-04 16:35:09', 'admin', 'admin'),
	(11, 'yyyyy', 'yyyyy', '7', 1, 'dbacec37cce79a58b2fa8890fc2e614b', 's42uf', '2019-02-27 00:00:00', 0, NULL, NULL, 0, '2019-03-04 16:44:12', '2019-03-04 16:44:12', 'admin', 'admin');
/*!40000 ALTER TABLE `sys_user` ENABLE KEYS */;


-- Dumping structure for テーブル db_quick_app.sys_user_department
...
-- Dumping data for table db_quick_app.sys_user_department: ~5 rows (approximately)
DELETE FROM `sys_user_department`;
/*!40000 ALTER TABLE `sys_user_department` DISABLE KEYS */;
INSERT INTO `sys_user_department` (`user_id`, `department_id`) VALUES
	(1, 3),
	(3, 3),
	(10, 3),
	(11, 1),
...
CREATE TABLE IF NOT EXISTS `sys_user_native_place` (
  ...
  `city_id` varchar(6) NOT NULL COMMENT '城市',
  `area_id` varchar(6) NOT NULL COMMENT '区域',
...
/*!40000 ALTER TABLE `sys_user_native_place` ENABLE KEYS */;
