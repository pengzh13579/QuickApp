...
CREATE TABLE IF NOT EXISTS `log_login` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=426 DEFAULT CHARSET=utf8 COMMENT='登录LOG表';

-- Dumping data for table db_quick_app.log_login: ~418 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `sys_contact` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='用户联系信息表';

-- Dumping data for table db_quick_app.sys_contact: ~5 rows (approximately)
...
-- Dumping structure for テーブル db_quick_app.sys_dict
...
-- Dumping data for table db_quick_app.sys_dict: ~0 rows (approximately)
...
INSERT INTO `sys_menu` (`id`, `code`, `pid`, `menu_real_name`, `icon`, `url`, `num`, `levels`, `menu_flag`, `tips`, `open_flag`, `dis_flag`, `create_date`, `update_date`, `create_user`, `update_user`) VALUES
	...
	(5, 'sys_menu', '1', '菜单管理', NULL, '/systemMenuController/list', 2, NULL, 1, NULL, 0, 0, '2018-08-28 20:02:55', '2018-08-28 20:02:57', 'admin', 'admin'),
	(6, 'sys_role', '1', '角色管理', NULL, '/systemRoleController/list', 3, NULL, 1, NULL, 0, 0, '2019-02-25 15:13:23', '2019-02-25 15:13:23', 'admin', 'admin'),
	(7, 'sys_department', '1', '部门管理', '', '/systemDepartmentController/list', 4, NULL, 1, NULL, 0, 0, '2019-02-28 10:49:14', '2019-02-28 10:49:14', 'admin', 'admin');
...
CREATE TABLE IF NOT EXISTS `sys_menu_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='菜单角色关联表';

-- Dumping data for table db_quick_app.sys_menu_role: ~7 rows (approximately)
DELETE FROM `sys_menu_role`;
/*!40000 ALTER TABLE `sys_menu_role` DISABLE KEYS */;
INSERT INTO `sys_menu_role` (`id`, `menu_id`, `role_id`) VALUES
	(1, 1, 1),
	(2, 2, 1),
	(3, 3, 1),
	(4, 4, 1),
...
-- Dumping data for table db_quick_app.sys_user: ~3 rows (approximately)
...
INSERT INTO `sys_user` (`id`, `user_name`, `REAL_NAME`, `avatar`, `sex`, `PASSWORD`, `SALT`, `birthday`, `is_online`, `role_id`, `dept_id`, `dis_flag`, `create_date`, `update_date`, `create_user`, `update_user`) VALUES
	(1, 'admin', '管理员', NULL, 0, 'ecfadcde9305f8891bcfe5a1e28c253e', '8pgby', '2018-08-23 19:28:47', 1, '1,2', 1, 0, '2018-08-23 19:29:05', '2019-03-01 16:19:46', 'admin', 'admin'),
	...
	(4, 'zhangsan', '张三', '0', 0, 'f06c1e017c2a663dfa47dee896d55bb4', 'mfbyp', '2019-02-27 00:00:00', 0, NULL, NULL, 1, '2019-02-27 13:55:48', '2019-02-27 15:26:49', 'admin', 'admin');
...
CREATE TABLE IF NOT EXISTS `sys_user_department` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户部门关联表';

-- Dumping data for table db_quick_app.sys_user_department: ~0 rows (approximately)
