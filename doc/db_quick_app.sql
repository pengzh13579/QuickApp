...
-- Dumping data for table db_quick_app.fix_province: 34 rows
DELETE FROM `fix_province`;
/*!40000 ALTER TABLE `fix_province` DISABLE KEYS */;
INSERT INTO `fix_province` (`id`, `province_id`, `province`) VALUES
	(1, '110000', '北京市'),
	(2, '120000', '天津市'),
	(3, '130000', '河北省'),
	(4, '140000', '山西省'),
...
-- Dumping data for table db_quick_app.sys_contact: ~3 rows (approximately)
...
-- Dumping structure for テーブル db_quick_app.sys_login_log
CREATE TABLE IF NOT EXISTS `sys_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=217 DEFAULT CHARSET=utf8 COMMENT='登录LOG表';

-- Dumping data for table db_quick_app.sys_login_log: ~255 rows (approximately)
DELETE FROM `sys_login_log`;
/*!40000 ALTER TABLE `sys_login_log` DISABLE KEYS */;
INSERT INTO `sys_login_log` (`id`, `log_name`, `create_user`, `create_date`, `succeed`, `message`, `ip`) VALUES
...
-- Dumping data for table db_quick_app.sys_menu: ~5 rows (approximately)
DELETE FROM `sys_menu`;
/*!40000 ALTER TABLE `sys_menu` DISABLE KEYS */;
INSERT INTO `sys_menu` (`id`, `code`, `pcode`, `name`, `icon`, `url`, `num`, `levels`, `is_menu`, `tips`, `is_open`, `dis_flag`, `create_date`, `update_date`, `create_user`, `update_user`) VALUES
	(1, 'sys_manager', '0', '系统管理', NULL, NULL, 1, NULL, 1, NULL, 1, 0, '2018-08-26 09:52:48', '2018-08-26 09:52:52', 'admin', 'admin'),
	(2, 'sys_user', 'sys_manager', '用户管理', NULL, '/systemUserController/userList', 1, NULL, 1, NULL, 0, 0, '2018-08-26 09:54:52', '2018-08-26 09:54:54', 'admin', 'admin'),
	(3, 'sys_notice', '0', '通知管理', NULL, NULL, 2, NULL, 1, NULL, 1, 0, '2018-08-26 09:56:06', '2018-08-26 09:56:08', 'admin', 'admin'),
	(4, 'sys_system', 'sys_notice', '系统通知管理', NULL, '/systemUserController/userList', 1, NULL, 1, NULL, 0, 0, '2018-08-26 09:57:06', '2018-08-26 09:57:09', 'admin', 'admin'),
	(5, 'sys_menu', 'sys_manager', '菜单管理', NULL, '/systemMenuController/menuList', 2, NULL, 1, NULL, 0, 0, '2018-08-28 20:02:55', '2018-08-28 20:02:57', 'admin', 'admin');
...
-- Dumping data for table db_quick_app.sys_menu_role: ~5 rows (approximately)
...
-- Dumping structure for テーブル db_quick_app.sys_operation_log
...
-- Dumping data for table db_quick_app.sys_operation_log: ~0 rows (approximately)
...
INSERT INTO `sys_role` (`id`, `num`, `code`, `name`, `tips`, `temp`, `dis_flag`, `create_date`, `update_date`, `create_user`, `update_user`) VALUES
	(1, 1, 'administrator', '超级管理员', NULL, NULL, 0, '2018-08-26 11:15:16', '2018-08-26 11:15:18', 'admin', 'admin'),
	(2, 2, 'manager', '管理员', NULL, NULL, 0, '2018-08-26 11:19:32', '2018-08-26 11:19:36', 'admin', 'admin');
...
-- Dumping data for table db_quick_app.sys_user: ~2 rows (approximately)
...
INSERT INTO `sys_user` (`id`, `user_name`, `REAL_NAME`, `avatar`, `sex`, `PASSWORD`, `SALT`, `birthday`, `is_online`, `role_id`, `dept_id`, `dis_flag`, `create_date`, `update_date`, `create_user`, `update_user`) VALUES
	(1, 'admin', '管理员', NULL, 0, 'ecfadcde9305f8891bcfe5a1e28c253e', '8pgby', '2018-08-23 19:28:47', 1, '1,2', 1, 0, '2018-08-23 19:29:05', '2018-08-29 17:15:03', 'admin', 'admin'),
	(3, 'admin22', '11', NULL, 1, 'ecfadcde9305f8891bcfe5a1e28c253e', '8pgby', '2018-08-26 13:55:22', 0, '1', 1, 0, '2018-08-26 13:55:26', '2018-08-26 13:55:28', 'admin', 'admin');
